                ...
                items:[
                    {
                        ...
                        items:[{
                            ...
                            handler:function(){
                                ...
                                var params = Ext.getCmp('frm-modal').getForm().getValues();
                                var loader = Ext.getCmp('panel-modal').getLoader();
                                var querystring = EncodeQueryData(params);
                                var url = m_crud + '/modal/generate2';
                            ...
                            handler:function(){
                                ...
                                var loader = Ext.getCmp('panel-modal').getLoader();
                                var querystring = EncodeQueryData(params);
                                var url = m_crud + '/modal/generate2/true';
