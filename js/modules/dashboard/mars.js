...
var ajaxDataRenderer = function(url) {
   var s = new Array();
    ...
    $.ajax({
        type: "GET",
        url: url,
        data: {prov: m_prov,kab: m_kab,priv: m_priv,daer: m_daer,partner:m_partner,cert_holder:m_cert_holder},
        ...
        success: function(r) {
            ...
            $('#volume').html(number_format(parseFloat(r['volume']),0,',',','));
            $('#quality').html(number_format(parseFloat(r['quality']),2,',',','));
