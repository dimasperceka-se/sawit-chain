...
* @Last Modified time: 2017-09-19 17:03:06
*/
...
var ajaxDataRenderer = function(url) {
    ...
    $.ajax({
        ...
        success: function(r) {
            ...
            $(".dashDateGen").html('Generated on '+r.dateGen);
        }
    });
...
$(function () {
    ...
    column_one(s['chart_poverty_15'], 'chart_poverty_15', lang('Baseline and Post-Line, $ 1.25/Day'), '', null, s.cat_poverty_province, 'normal', 1, true, -45, 3);
    column_one(s['chart_poverty_25'], 'chart_poverty_25', lang('Baseline and Post-Line, $ 2.5/Day'), '', null, s.cat_poverty_province, 'normal', 1, true, -45, 10);
})