/*
* @Author: nikolius
* @Date:   2016-03-31 13:30:19
* @Last Modified by:   nikolius
* @Last Modified time: 2016-03-31 14:44:39
*/
Ext.onReady(function() {
   ...
   Ext.define('Scpp.Model', {
      ...
      fields: ['CommodityTypeID', 'CommodityTypeName', 'StatusCode'],
   });
   ...
   var grid = Ext.create('Ext.grid.Panel', {
                     ...
                     Ext.MessageBox.confirm('Message', 'Are you sure want to delete this data ?', function(btn) {
                        if (btn == 'yes') {
                           Ext.Ajax.request({
                              ...
                              method: 'DELETE',
                              params: {
                                 CommodityTypeID: smb.raw.CommodityTypeID
                              },
      ...
      listeners: {
         ...
         'edit': function(editor, e) {
            var CommodityTypeID = e.record.data.CommodityTypeID;
            var CommodityTypeName = e.record.data.CommodityTypeName;
            var StatusCode = e.record.data.StatusCode;

            if(CommodityTypeID.trim() === ''){
               console.log('insert');
