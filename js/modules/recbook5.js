...
//            resetForm();
                ...
                items:[
                    {
                        ...
                        title:lang('P E N D A P A T A N'),
                        items:[
                                ...
                                items: [
                                                ...
                                                items:[
                                                    {
                                                        ...
                                                        fieldLabel:lang('Diterima Dari <b style="color:red">*</b>'),
                                                        allowBlank:false,
                                                        width:400,
                                                        name:'name'
                                                    },
                                                    {
                                                        xtype: 'radiogroup',
                                                        id:'trans-type-received',
                                                        fieldLabel: lang('Dalam Bentuk <b style="color:red">*</b>'),
                                                        items: [
                                                            {boxLabel: 'Cash', name: 'trans_type', inputValue: 1},
                                                            {boxLabel: 'Non Cash', name: 'trans_type', inputValue: 2}
                                                        ],
                                                        listeners:{
                                                            change: function(c,v){
                                                                 // Ext.getCmp('cmb-add-source-fund').setValue(null);

                                                                var type = 'received';
                                                                var trans = v;
                                                                // console.log(trans);
                                                                var payment = Ext.getCmp('payment-type-received').getValue();
                                                                // console.log('/payment')
                                                                // console.log(payment);
                                                                // console.log('payment/')

                                                                // var cmbfrom = Ext.getCmp('cmb-add-source-fund').getStore().getProxy();
                                                                var cmbto = Ext.getCmp('cmb-add-to-fund').getStore().getProxy();

                                                                // cmbfrom.extraParams = {'type':type,'trans':trans,'payment':payment};
                                                                // Ext.getCmp('cmb-add-source-fund').getStore().load();

                                                                cmbto.extraParams = {'type':type,'trans':trans,'payment':payment};
                                                                Ext.getCmp('cmb-add-to-fund').getStore().load();

                                                                // console.log(v);
                                                                if(v.trans_type*1==1)
                                                                {
                                                                     Ext.getCmp('payment-type-received').hide();
                                                                } else {
                                                                    Ext.getCmp('payment-type-received').show();
                                                                }
                                                    ...
                                                    },
                                                    {
                                                        ...
                                                        items: [
                                                            {boxLabel: 'Transfer', name: 'payment-type', inputValue: 1},
                                                            {boxLabel: 'Cheque', name: 'payment-type', inputValue: 2}
                                                        ],
                                                        listeners:{
                                                            change: function(c,v){
                                                                ...
                                                                var type = 'received';
                                                                var trans = Ext.getCmp('trans-type-received').getValue();
                                                                var payment = v;

                                                                // var cmbfrom = Ext.getCmp('cmb-add-source-fund').getStore().getProxy();
                                                                var cmbto = Ext.getCmp('cmb-add-to-fund').getStore().getProxy();

                                                                // cmbfrom.extraParams = {'trans':trans,'payment':payment};
                                                                // Ext.getCmp('cmb-add-source-fund').getStore().load();
                                                    ...
                                                    },
                                                    {
                                                        ...
                                                        items:[{
                                                            ...
                                                            fieldLabel: lang('Disimpan pada') + ' <b style="color:red">*</b>',
                                                            allowBlank: false,
                                                            width:400,
                                                            store: Ext.create('Ext.data.Store', {
                                                    ...
                                                    },
                                                    {
                                                        xtype: 'combo',
                                                        id:'cmb-add-to-fund',
                                                        fieldLabel: lang('Untuk Pembayaran <b style="color:red">*</b>'),
                                                        allowBlank: false,
                                                        width:400,
                                                        store: Ext.create('Ext.data.Store', {
                                                            fields: ['id', 'label'],
                                                            ...
                                                            proxy: {
                                                                type: 'rest',
                                                                url: m_api + 'transaction/combo_coa', // url that will load data with respect to start and limit params
                                                                reader: {
                                                                    type: 'json',
                                                                    root: 'data',
                                                                    totalProperty: 'total'
                                                    ...
                                                    },
                                                    {
                                                        ...
                                                        fieldLabel:lang('JUMLAH <span style="color:red;font-weight:bold">*</span>')
                                                    },
                                                    {
                                                        xtype: 'textarea',
                                                        fieldLabel: 'Catatan',
                                    ...
                                    Ext.create('Ext.grid.Panel', {
                                        ...
                                        store: Ext.create('Ext.data.Store', {
                                            ...
                                            storeId:'store-grid-today-received',
                                            autoLoad:true,
                                            proxy: {
                                                type: 'ajax',
                                                url: m_api+'transaction/todayrec/' + '1',
                                                reader: {
                                                    type: 'json',
                                                    root: 'data'
                                                }
                                        ...
                                        dockedItems:[
                                            {
                                                ...
                                                plain:true,
                                                items:[
                                                    '<span><b>Today\'s Received</b></span>'
                                                ]
                                            },
                                            {
                                                xtype: 'pagingtoolbar',
                                                store: Ext.data.StoreManager.lookup('store-grid-today-received'),
                                                dock: 'bottom',
                                                displayInfo: true
                                            }
                                        ],
                    ...
                    },
                    {
                        ...
                        title:lang('P E N G E L U A R A N'),
                            ...
                            items: [
                                            ...
                                            items:[
                                                {
                                                    ...
                                                    fieldLabel:lang('Diberikan kepada <b style="color:red">*</b>'),
                                                    allowBlank:false,
                                                    width:400,
                                                    name:'name'
                                                },
                                                {
                                                    ...
                                                    items: [
                                                        ...
                                                        listeners:{
                                                            change: function(c,v){
                                                                // Ext.getCmp('cmb-add-source-fund-with').setValue(null);

                                                                var type = 'spent';
                                                                var trans = v;

                                                                var payment = Ext.getCmp('payment-type-spent').getValue();

                                                                // var cmbfrom = Ext.getCmp('cmb-add-source-fund-with').getStore().getProxy();
                                                                var cmbto = Ext.getCmp('cmb-add-to-with').getStore().getProxy();

                                                                // cmbfrom.extraParams = {'type':type,'trans':trans,'payment':payment};
                                                                // Ext.getCmp('cmb-add-source-fund-with').getStore().load();

                                                                cmbto.extraParams = {'type':type,'trans':trans,'payment':payment};
                                                                Ext.getCmp('cmb-add-to-with').getStore().load();

                                                                // console.log(v.tran);
                                                                if(v.trans_type*1==1)
                                                                {
                                                                    Ext.getCmp('payment-type-spent').hide();
                                                                } else {
                                                                    Ext.getCmp('payment-type-spent').show();
                                                                }
                                                        }
                                                    }
                                                },
                                                ...
                                                },
                                                {
                                                    ...
                                                    fieldLabel: lang('Diambil dari') + ' <b style="color:red">*</b>',
                                                    allowBlank: false,
                                                    width:400,
                                                    store: Ext.create('Ext.data.Store', {
                                                        fields: ['cashSourceID', 'cashSourceName'],
                                                ...
                                                },
                                                {
                                                    ...
                                                    name:'amount',
                                                    fieldStyle:'text-align:right;font-size:20px;font-weight:bold;font-family:Courier New;',
                                                    fieldLabel:'AMOUNT <span style="color:red;font-weight:bold">*</span>'
                                                },
                                                {
                                                    xtype: 'textarea',
                                                    fieldLabel: 'Remark',
                                ...
                                Ext.create('Ext.grid.Panel', {
                                    ...
                                    store: Ext.create('Ext.data.Store', {
                                        ...
                                        storeId:'store-grid-today-spent',
                                        autoLoad:true,
                                        proxy: {
                                            type: 'ajax',
                                            url: m_api+'transaction/todayrec/' + '2',
                                            reader: {
                                                type: 'json',
                                                root: 'data'
                                            }
                                    ...
                                    dockedItems:[
                                        {
                                            ...
                                            plain:true,
                                            items:[
                                                '<span><b>Today\'s Spents</b></span>'
                                            ]
                                        },
                                        {
                                            xtype: 'pagingtoolbar',
                                            store: Ext.data.StoreManager.lookup('store-grid-today-spent'),
                                            dock: 'bottom',
                                            displayInfo: true
                                        }
                                    ],
    ...
    function switchReceive(){
        var val = {trans_type: 1};
        Ext.getCmp('trans-type-received').setValue(val);
        var v = Ext.getCmp('payment-type-received').getValue();
        var type = 'received';
        var trans = val;
        var payment = 1;
