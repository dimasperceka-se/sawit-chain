Ext.onReady(function(){
    var store = Ext.create('Ext.data.Store', {
        ...
        fields: ['CategoryID','ParentCategoryID', 'Name', 'Description'],
        autoLoad: true,
        pageSize: 50,
        proxy: {
            type: 'ajax',
    ...
    function set_update(sm) {
       Ext.Ajax.request({
           url: m_crud+'_c',
           method: 'GET',
           params: {CategoryID: sm.get('CategoryID')},
           success: function(fp, o){
               var r = Ext.decode(fp.responseText);console.log(r)
               Ext.getCmp('CategoryID').setValue(sm.get('CategoryID'));
               ...
               Ext.getCmp('ParentCategoryID').setValue(r.ParentCategoryID);
               ...
               handler : function(){
                 ...
                 Ext.MessageBox.confirm('Message', lang('Apakah anda mau menghapus data ini ?') , function(btn){
                     if(btn == 'yes'){
                        ...
                        url: m_crud,
                        method : 'DELETE',
                        params: {CategoryID:  smb.raw.CategoryID},
    ...
    var DataForm = Ext.create('Ext.form.Panel', {
        ...
        buttons: [{
            ...
            handler: function() {
                ...
                var method;
                if (Ext.getCmp('CategoryID').getValue()!='') method = 'PUT'; else method = 'POST';
                form.submit({
                    url: m_crud,
                    method:method,
