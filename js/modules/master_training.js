...
var ajaxDataRenderer = function(url) {
    ...
    $.ajax({
        type: "GET",
        url: url,
        data: {prov: m_prov,kab: m_kab,priv: m_priv,daer: m_daer,partner:m_partner,staff_type:m_staff_type},
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        async: false,
        success: function(r) {
            var gap = 0, gnp = 0, gfp = 0, gep = 0, gbp = 0, agap = 0, gsp = 0, cst = 0;
            ...
            for (var i=0;i<jumlah.length;i++) {
                ...
                chart_data_cst[i] = parseInt(jumlah[i]['cst']);
                ...
                chart_tahun_cst[i] = [];
                chart_tahun_cst[i][0] = parseInt(jumlah[i]['cst_2010']);
                chart_tahun_cst[i][1] = parseInt(jumlah[i]['cst_2011']);
                chart_tahun_cst[i][2] = parseInt(jumlah[i]['cst_2012']);
                chart_tahun_cst[i][3] = parseInt(jumlah[i]['cst_2013']);
                chart_tahun_cst[i][4] = parseInt(jumlah[i]['cst_2014']);
                chart_tahun_cst[i][5] = parseInt(jumlah[i]['cst_2015']);
                chart_tahun_cst[i][6] = parseInt(jumlah[i]['cst_2016']);
                chart_tahun_cst[i][7] = parseInt(jumlah[i]['cst_2017']);
            }
            ...
            chart['chart_data_cst'] = chart_data_cst;
            ...
            chart['chart_tahun_cst'] = chart_tahun_cst;
...
column([{name: lang('CST Cocoa Sector Training Participants'),data: chart.chart_data_cst}], 'chart_cst', lang('CST Cocoa Sector Training Participants'), lang('Petani'), ['#3B5323'], chart.chart_categories, 'normal');
...
column(tahun_cst,'tahun_cst', lang('CST Cocoa Sector Training Participants'), lang('Petani'), ['#3B5323','#446B1E','#4E8419','#589C14','#61B50F'],chart.year_categories,'normal',0,true);