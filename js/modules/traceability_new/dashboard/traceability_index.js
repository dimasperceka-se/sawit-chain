    ...
    function setBox(DateStart,DateEnd,sshSupplychainID,sshSupplyChildID){
        ...
        Ext.Ajax.request({
            ...
            success: function(response, opts){
                ...
                //switch(obj.success){
                $('#box1').html(numberWithCommas(obj.traceable_sales));
                $('#box2').html(obj.number_of_farmer );
                $('#tgl').html('Updated : '+obj.tgl);
                $('#box3').html(numberWithCommas(obj.number_of_transaction));
                                                        ...
                                                        items: [
                                                            {
                                                                ...
                                                                html: '<div class="main-content" >'
                                                                    ...
                                                                    + '</div>'
                                                                    + '<div class="icon col-md-4"><img src="' + m_base_url + 'img/general/icn_Seaweedtraceweb-01.png" alt=""></div>'
                                                                    + '</div>'
                                                                    + '</div>'
                                                                    ...
                                                                    + '<div class="desc">' + lang('Number of Farmer Sales') + '</div>'
                                                                    + '</div>'
                                                                    ...
                                                                    + '<div class="desc">' + lang('Number of Farmer`s Transactions') + '</div>'
                                                                    + '</div>'
