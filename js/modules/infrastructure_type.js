/*
* @Author: nikolius
* @Date:   2016-03-31 16:49:09
* @Last Modified by:   nikolius
* @Last Modified time: 2016-03-31 16:50:51
*/
Ext.onReady(function() {
   ...
   Ext.define('Scpp.Model', {
      ...
      fields: ['InfrastructureTypeID', 'InfrastructureTypeName', 'StatusCode'],
   });
   ...
   var grid = Ext.create('Ext.grid.Panel', {
                     ...
                     Ext.MessageBox.confirm('Message', 'Are you sure want to delete this data ?', function(btn) {
                        if (btn == 'yes') {
                           Ext.Ajax.request({
                              ...
                              method: 'DELETE',
                              params: {
                                 InfrastructureTypeID: smb.raw.InfrastructureTypeID
                              },
      ...
      columns: [
         {
            dataIndex: 'InfrastructureTypeID',
            hidden: true
         },{
            text: 'No',
            xtype: 'rownumberer',
            ...
            text: lang('infrastructure_type'),
            width: '77%',
            dataIndex: 'InfrastructureTypeName',
            editor: {
               xtype: 'textfield',
               allowBlank: false
            }
      ...
      listeners: {
         ...
         'edit': function(editor, e) {
            var InfrastructureTypeID = e.record.data.InfrastructureTypeID;
            var InfrastructureTypeName = e.record.data.InfrastructureTypeName;
            var StatusCode = e.record.data.StatusCode;

            if(InfrastructureTypeID.trim() === ''){
               console.log('insert');
