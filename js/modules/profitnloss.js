                ...
                items:[
                    {
                        ...
                        items:[{
                            ...
                            handler:function(){
                                ...
                                var params = Ext.getCmp('frm-pnl').getForm().getValues();
                                var loader = Ext.getCmp('panel-pnl').getLoader();
                                var querystring = EncodeQueryData(params);
                                var url = m_crud + '/pnl/generate2';
                            ...
                            handler:function(){
                                ...
                                var loader = Ext.getCmp('panel-pnl').getLoader();
                                var querystring = EncodeQueryData(params);
                                var url = m_crud + '/pnl/generate2/true';
