...
//add/update
    ...
    function setFormValue(r) {
        ...
        Ext.getCmp('parcheklistday_trainingid').setValue(r.BsnTrainingID);
        ...
        items: [
            {
                ...
                store: Ext.create('Ext.data.Store', {
                    ...
                    {'id':'staff', 'label':lang('Staff'),},
                    ]
                }),
                displayField: 'label',
                valueField: 'id',
                fieldLabel: lang('Choose Type'),
                queryMode: 'local',
                allowBlank: false,
                id: 'typeAddPart',
                name: 'typeAddPart',
                ...
                listeners: {
                    change: function(cb, nv, ov) {
                        if (nv == 'farmer') {
                            Ext.getCmp('grid_participant_add_farmer').show();
                            Ext.getCmp('grid_participant_add_staff').hide();
                        } else if (nv == 'staff') {
                            Ext.getCmp('grid_participant_add_farmer').hide();
                            Ext.getCmp('grid_participant_add_staff').show();
                        }
                    }
                }
            }, 
            {
                xtype: 'gridpanel',
                id: 'grid_participant_add_farmer',
                store: store_participant_add_farmer,
                loadMask: true,
                hidden: true,
                dockedItems: [
                        {
                                ...
                                listeners: {
                                    change: function(cb, nv, ov) {
                                        store_kabupaten_participant.load({
                                            params: {
                                                ProvinceID: Ext.getCmp('provAddPart').getValue()
                                            }});
                                    }
                                }
                            }, 
                            {
                                ...
                                listeners: {
                                    change: function(cb, nv, ov) {
                                        store_kecamatan_participant.load({
                                            params: {
                                                DistrictID: nv
                                            }});
                                    }
                            ...
                            },
                            {
                                ...
                                // width: 180,
                                labelWidth: 60,
                                store: store_kecamatan_participant,
                                displayField: 'label',
                                valueField: 'id',
                                queryMode: 'local',
                                listeners: {
...

                        {
                            ...
                            {
                                xtype: 'textfield',
                                name: 'keyAddPartFarmer',
                                id: 'keyAddPartFarmer',
                                emptyText: 'Cari berdasar nama/ID',
                                // width: 150,
                                fieldLabel: lang('Name or ID'),
                                labelWidth: 80,
                                listeners: {}
                            }, {
                                xtype: 'button',
                                ...
                                text: lang('Search'),
                                handler: function() {
                                    store_participant_add_farmer.load({
                                        params: {
                                            training: Ext.getCmp('id').getValue(),
                                            ProvinceID: Ext.getCmp('provAddPart').getValue(),
                                            DistrictID: Ext.getCmp('kabAddPart').getValue(),
                                            SubDistrictID: Ext.getCmp('kecAddPart').getValue(),
                                            CPGid: Ext.getCmp('cpgAddPart').getValue(),
                            ...
                            items: [
                            {
                                ...
                                store: Ext.create('Ext.data.Store', {
                                    ...
                                    data: [
                                        ...
                                        {'id':'bank', 'label':'Bank',},
                                        {'id':'farmergroup', 'label':'Farmergroup',},
                                    ]
                                }),
                                displayField: 'label',
                                valueField: 'id',
