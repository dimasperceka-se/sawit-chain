/*
* @Author: nikolius
* @Date:   2017-03-17 16:07:38
* @Last Modified by:   nikolius
* @Last Modified time: 2017-03-20 11:52:45
*/
Ext.onReady(function() {
    ...
    var traderSurListStore = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            type: 'ajax',
            url: m_api + '/prog_sce_trader/traderSurList',
            extraParams: {
                FarmerID: m_FarmerID
            },
            reader: {
    ...
    var ListDataPanel = Ext.create('Ext.panel.Panel', {
            ...
            listeners: {
                itemdblclick: function(dv, record, item, index, e) {
                    if (record.get('TraderSurID') != undefined) {
                        prosesFormUpdate(record.get('TraderSurID'));
                    }
                }
            },
            dockedItems: [{
                ...
                items: [{
                    ...
                    scope: this,
                    handler: function() {
                        Ext.getCmp('mainPanel').setVisible(true);
                        Ext.getCmp('dataFormMainPanel').getForm().reset();
                    }
                },{
                    ...
                    handler: function() {
                        ...
                        if(smb == undefined){
                            ...
                            prosesFormUpdate(smb.raw.TraderSurID);
                        }
                    }
                },{
                    itemId: 'remove',
                    ...
                    scope: this,
                    handler: function() {
                        Ext.getCmp('mainPanel').setVisible(false);
                        var smb = Ext.getCmp('traderSurGrid').getSelectionModel().getSelection()[0];
                        ...
                        if(smb == undefined){
                            ...
                            Ext.MessageBox.confirm('Message', 'Do you want to delete this data ?', function(btn) {
                                if (btn == 'yes') {
                                    Ext.Ajax.request({
                                        waitMsg: 'Please Wait',
                                        url: m_api + '/prog_sce_trader/traderSurvey',
                                        method: 'DELETE',
                                        params: {
    ...
    function prosesFormUpdate(TraderSurID){
        Ext.getCmp('dataFormMainPanel').getForm().load({
            url: m_api + '/prog_sce_trader/traderSurveyGetForm',
            method: 'GET',
            params: {
            ...
            success: function(form, action) {
                ...
                if(m_act_update == false){
                    Ext.getCmp('btnSaveFormData').setVisible(false);
                }
            },
