...
var contextMenuGridRefinery = Ext.create('Ext.menu.Menu',{
    items:[{
        id:'button_update_data_OS',
        icon: varjs.config.base_url + 'images/icons/new/update.png',
        text: lang('Update'),
        handler: function() {
            var sm = Ext.getCmp('Koltiva.view.Refinery.OtherSupplier-GridOtherSupplier').getSelectionModel().getSelection()[0];
...
var storeGridOtherSupplier = Ext.create('Koltiva.store.Refinery.GridOtherSupplier');
Ext.define('Koltiva.view.Refinery.GridOtherSupplier' ,{
    extend: 'Ext.panel.Panel',
    title: lang('Grid Other Suppliers (Direct Smallholder, Dealer/Agent/Vendor'),
    frame: true,
    collapsible:false,
    id: 'Koltiva.view.Refinery.GridOtherSupplier',
    margin:'0 0 20 0',
    viewConfig: {
    ...
    initComponent: function() {
        ...
        thisObj.items = [{
            xtype: 'grid',
            id: 'Koltiva.view.Refinery.OtherSupplier-GridOtherSupplier',
            loadMask: true,
            selType: 'rowmodel',
            ...
            dockedItems: [{
                xtype: 'pagingtoolbar',
                id: 'Koltiva.view.Refinery.GridOtherSupplier-gridToolbar',
                store: storeGridOtherSupplier,
                dock: 'bottom',
                displayInfo: true
            },{
    ...
    listeners: {
        afterRender: function(){
            ...
            //load store Document
            var grid_company_owned_estate = Ext.data.StoreManager.lookup('Koltiva.store.Refinery.GridOtherSupplier');
