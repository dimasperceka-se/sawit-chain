...
Ext.define('Koltiva.view.Refinery.PanelTabSummaryReport' ,{
    extend: 'Ext.form.Panel',
    id: 'Koltiva.view.Refinery.PanelTabSummaryReport',    
    fileUpload: true,
    ...
    PrintProfile: function(RefineryID,YearStartReport,YearEndReport,MonthStartReport,MonthEnd){
        preview_cetak_surat(m_api + '/refinery/refinery_summary/RefineryID/'+RefineryID+'/YearStart/'+YearStart+'/YearEnd/'+YearEnd+'/MonthStart/'+MonthStart+'/MonthEnd/'+MonthEnd);
    },
    initComponent: function() {
        ...
        var url = m_url+'/refinery/summary_report';
                            ...
                            items:[{
                                ...
                                items: [{
                                    ...
                                    handler:function(c){
                                        ...
                                        thisObj.PrintProfile(thisObj.viewVar.RefineryID,YearStartReport,YearEndReport,MonthStartReport,MonthEnd);
                                    }
                                }]
                            }]
                        }]
    ...
    listeners: {
        afterRender: function(){
            ...
            //load data form
            Ext.getCmp('Koltiva.view.Refinery.PanelTabSummaryReport').getForm().load({
