Ext.define('Koltiva.view.Refinery.GridProductProfile' ,{
    extend: 'Ext.panel.Panel',
    id: 'Koltiva.view.Refinery.GridProductProfile',  
    initComponent: function() {
        var thisObj = this;
        //store
        var storeGridMainProduct = Ext.create('Koltiva.store.Refinery.GridProductProfile');
		...
		var contextMenuProductGrid = Ext.create('Ext.menu.Menu',{
            ...
            items:[ {
                ...
                handler: function() {
                        ...
                        var sm = Ext.getCmp('Koltiva.view.Refinery.GridProductProfile-gridMainGrid').getSelectionModel().getSelection();
                        if (sm[0]) {
        ...
        thisObj.items = [{
            xtype: 'grid',
            id: 'Koltiva.view.Refinery.GridProductProfile-gridMainGrid',
            ...
            dockedItems: [{
                xtype: 'pagingtoolbar',
                id: 'Koltiva.view.Refinery.GridProductProfile-gridToolbar',
                store: storeGridMainProduct,
                dock: 'bottom',
                displayInfo: true
            }],
            ...
            listeners: {
                ...
                'canceledit': function (editor, e, eOpts) {
                    Ext.getCmp('Koltiva.view.Refinery.GridProductProfile-gridMainGrid').getStore().load();
                },
                ...
                'edit': function (editor, e) {
                    ...
                    var SupplychainID = Ext.getCmp('Koltiva.view.Refinery.FormMainRefineryProfile-FormBasicData-SupplychainID').getValue();
                    ...
                    if(Ext.getCmp('Koltiva.view.Refinery.FormMainRefineryProfile-FormBasicData-SupplychainID')){
						Ext.Ajax.request({
							waitMsg: lang('Please wait...'),
							url: m_api + '/traceability_api/Supplychain_product/submit_refinery',
							method: 'POST',
							params: {
