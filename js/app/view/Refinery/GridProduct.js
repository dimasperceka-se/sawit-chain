Ext.define('Koltiva.view.Refinery.GridProduct' ,{
    extend: 'Ext.panel.Panel',
    id: 'Koltiva.view.Refinery.GridProduct',  
    initComponent: function() {
        var thisObj = this;
        //store
        var storeGridMainProduct = Ext.create('Koltiva.store.Refinery.GridProduct');
        ...
        var oil_type = Ext.create('Ext.data.Store', {
            fields: ['id', 'label'],
            data: [{
                "id": "1",
                "label": lang("CPO")
		...
		var contextMenuProductGrid = Ext.create('Ext.menu.Menu',{
            ...
            items:[ {
                ...
                handler: function() {
                        ...
                        var sm = Ext.getCmp('Koltiva.view.Refinery.GridProduct-gridMainGrid').getSelectionModel().getSelection();
                        if (sm[0]) {
	            ...
	            handler: function(){
						var smb = Ext.getCmp('Koltiva.view.Refinery.GridProduct-gridMainGrid').getSelectionModel().getSelection()[0];
                        RowEditingProduct.cancelEdit();
                                ...
                                if (btn == 'yes') {
                                    Ext.Ajax.request({
                                        ...
                                        success: function (response, opts) {
                                            ...
                                            switch (obj.success) {
                                                case true:
                                                    Ext.getCmp('Koltiva.view.Refinery.GridProduct-gridMainGrid').getStore().load();
        ...
        thisObj.items = [{
            xtype: 'grid',
            id: 'Koltiva.view.Refinery.GridProduct-gridMainGrid',
            ...
            dockedItems: [{
                xtype: 'pagingtoolbar',
                id: 'Koltiva.view.Refinery.GridProduct-gridToolbar',
                store: storeGridMainProduct,
                dock: 'bottom',
                displayInfo: true
            },{
                ...
                items: [{
                    ...
                    // disabled:true,
					id :'Koltiva.view.Refinery.GridProduct-gridMainGrid-BtnAdd',
                    handler: function () { 
						
                        if(Ext.getCmp('Koltiva.view.Refinery.FormMainRefinery-FormBasicData-SupplychainID').getValue() == '') {
                            Ext.MessageBox.alert('Warning', lang('Please save form refinery data first and setting in traceability menu !'));
                        } else {
                            RowEditingProduct.cancelEdit();
                                    
                            var record = Ext.getCmp('Koltiva.view.Refinery.GridProduct-gridMainGrid').getStore();
            ...
            listeners: {
                ...
                'edit': function (editor, e) {
                    ...
                    var SupplychainID = Ext.getCmp('Koltiva.view.Refinery.FormMainRefinery-FormBasicData-SupplychainID').getValue();
                    var ProductID = e.record.data.ProductID;
                    var OilType = e.record.data.OilType;
                    ...
                    if(Ext.getCmp('Koltiva.view.Refinery.FormMainRefinery-FormBasicData-SupplychainID') != ''){
						Ext.Ajax.request({
							waitMsg: lang('Please wait...'),
