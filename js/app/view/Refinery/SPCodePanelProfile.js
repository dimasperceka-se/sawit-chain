Ext.define('Koltiva.view.Refinery.SPCodePanelProfile' ,{
    extend: 'Ext.panel.Panel',
    id: 'Koltiva.view.Refinery.SPCodePanelProfile',
    title: lang('SPB Code'),
    viewVar: false,
            ...
            dockedItems: [{
                ...
                items: [{
                    ...
                    handler: function(form, action) {
                        var gridSpCodePanel = Ext.data.StoreManager.lookup('store.Refinery.GridSpCodePanel');
                        console.log(gridSpCodePanel);
                        var WinFormSPCode = Ext.create('Koltiva.view.Refinery.WinFormSPCode', {
                            viewVar: {
                                RefineryID: gridSpCodePanel.lastOptions.params.RefineryID,
                                OpsiDisplay: 'insert',
                                CallerStore: thisObj.MainGrid,
                                CallFrom: thisObj.viewVar.CallFrom
                            }
