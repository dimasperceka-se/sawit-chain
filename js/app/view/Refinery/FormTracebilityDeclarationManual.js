...
Ext.define('Koltiva.view.Refinery.FormTracebilityDeclarationManual' ,{
    extend: 'Ext.panel.Panel',
    id: 'Koltiva.view.Refinery.FormTracebilityDeclarationManual',
    ...
    initComponent: function() {
        ...
        var StoreGridSupplier = Ext.create('Ext.data.Store', {
            ...
            proxy: {
                type: 'ajax',
                url: m_api_base_url+'/refinery/get_supplier_list',
                extraParams: {RefineryTCDID: thisObj.RefineryTCDID},
                reader: {
                    type: 'json',
                    root: 'data',
                    totalProperty: 'total'
        ...
        var objTracebiltyDeclaration = Ext.create('Ext.form.Panel',{
            ...
            frame: true,
            id: 'Koltiva.view.Refinery.FormTracebilityDeclarationManual-FormTracebiltyDeclaration',
            fileUpload: true,
            margin:'0 0 20 0',
            items: [{
                layout: 'column',
                ...
                items:[{
                    ...
                    items:[{
                        ...
                        layout: 'column',
                        id: 'Koltiva.view.Refinery.FormTracebilityDeclarationManual-Form-gridSupplier',
                        border: false,
                        items:[{
                            columnWidth: 1,
                            ...
                            items:[{
                                ...
                                xtype: 'grid',
                                id: 'Koltiva.view.Refinery.FormTracebilityDeclarationManual-gridSupplier',
                                loadMask: true,
                                ...
                                dockedItems: [{
                                    ...
                                    items: [{
                                        ...
                                        handler: function() {
                                            ...
                                            setTimeout(function(){
                                                $('#loader-ext').hide();
                                                var winFromAddSupplier = Ext.create('Koltiva.view.Refinery.FormAddSupplier');
                ...
                buttons: [{
                    ...
                    id: 'Koltiva.view.Refinery.FormTracebilityDeclarationManual-FormTracebiltyDeclaration-BtnSave',
                    handler: function () {
                        var Formnya = Ext.getCmp('Koltiva.view.Refinery.FormTracebilityDeclarationManual-FormTracebiltyDeclaration').getForm();

                        if (Formnya.isValid()) {
                            var gridContact = Ext.getCmp('Koltiva.view.Refinery.FormTracebilityDeclarationManual-gridSupplier');
                            ...
                            Formnya.submit({
                                url: m_api + '/refinery/submit_tc_declaration',
                                method: 'POST',
                                waitMsg: 'Saving data...',
                                params: {
                                ...
                                success: function (fp, o) {
                                    Ext.MessageBox.show({
                                        ...
                                        fn: function (btn) {
                                            if (btn == 'ok') {
                                                Ext.getCmp('Koltiva.view.Refinery.FormTracebilityDeclarationManual').destroy(); //destory current view
                                                var MainForm = [];
                                                if (Ext.getCmp('Koltiva.view.Refinery.GridTracebilityDeclarationManual') == undefined) {
                                                    MainForm = Ext.create('Koltiva.view.Refinery.GridTracebilityDeclarationManual');
                                                } else {
    ...
    listeners: {
        afterRender: function(){
            ...
            if(thisObj.opsiDisplay == 'update'){
                //load data form
                Ext.getCmp('Koltiva.view.Refinery.FormTracebilityDeclarationManual-FormTracebiltyDeclaration').getForm().load({
