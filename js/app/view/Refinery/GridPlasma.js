...
var contextMenuGridRefinery = Ext.create('Ext.menu.Menu',{
    items:[{
        ...
        hidden: m_act_update,
        handler: function(){
            var sm = Ext.getCmp('Koltiva.view.Refinery.Plasma-GridPlasma').getSelectionModel().getSelection()[0];
...
var storeGridPlasma = Ext.create('Koltiva.store.Refinery.GridPlasma');
Ext.define('Koltiva.view.Refinery.GridPlasma' ,{
    extend: 'Ext.panel.Panel',
    title: lang('Grid Plasma Smallholders (Estate Plasma)'),
    frame: true,
    collapsible:false,
    id: 'Koltiva.view.Refinery.GridPlasma',
    margin:'0 0 20 0',
    viewConfig: {
    ...
    initComponent: function() {
        ...
        thisObj.items = [{
            xtype: 'grid',
            id: 'Koltiva.view.Refinery.Plasma-GridPlasma',
            loadMask: true,
            selType: 'rowmodel',
            ...
            dockedItems: [{
                xtype: 'pagingtoolbar',
                id: 'Koltiva.view.Refinery.GridPlasma-gridToolbar',
                store: storeGridPlasma,
                dock: 'bottom',
                displayInfo: true
            },{
    ...
    listeners: {
        afterRender: function(){
            ...
            //load store Document
            var grid_company_owned_estate = Ext.data.StoreManager.lookup('Koltiva.store.Refinery.GridPlasma');
