Ext.define('Koltiva.view.Refinery.WinFaAssignment', {
    extend: 'Ext.window.Window',
    id: 'Koltiva.view.Refinery.WinFaAssignment',
    ...
    initComponent: function () {
        ...
        var storeStaffList = Ext.create('Koltiva.store.Refinery.ListStaffAssignment', {
            storeVar: {
        ...
        var dsReport = Ext.create('Ext.data.ArrayStore', {
            ...
            proxy: {
                type: 'ajax',
                url: m_api + '/refinery/staff_assignment',
                extraParams: {RefineryID: thisObj.viewVar.RefineryID},
                reader: {
                    type: 'json',
                    root: 'data'
                }
        ...
        thisObj.items = [{
                xtype: 'form',
                id: 'Koltiva.view.Refinery.WinFaAssignment-Form',
                padding: '20 25 10 10',
                items: [{
                        layout: 'column',
                        border: false,
                        items: [{
                            ...
                            items: [{
                                    ...
                                    toTitle: lang('Refinery FA Assignment')
                            }]
                        }]
                    }]
            }]
    ...
    onSaveClick: function () {
        var thisObj = this;
        var form = Ext.getCmp('Koltiva.view.Refinery.WinFaAssignment-Form').getForm();
        if (form.isValid()) {
            // Ext.MessageBox.alert('Submitted Values', form.getValues(true));
            form.submit({
                url: m_api + '/refinery/setFaAssignment',
                method: 'POST',
                params: {RefineryID: this.viewVar.RefineryID},
