 ...
 *  File : WinSelectMemberGeneralMultiple.js
 *******************************************/
/*
...
Ext.define('Koltiva.view.Widget.WinSelectMemberGeneralMultiple' ,{
    extend: 'Ext.window.Window',
    id: 'Koltiva.view.Widget.WinSelectMemberGeneralMultiple',
    ...
    initComponent: function() {
        ...
        thisObj.MainGrid = Ext.create('Koltiva.store.Widget.WinSelectMemberGeneralMainGrid',{
        	storeVar: {
                ...
                ExceptionID: thisObj.viewVar.ExceptionID,
                TextSearch: null,
                ProvinceID: null,
                DistrictID: null,
                SubDistrictID: null,
        ...
        thisObj.buttons = [{
            ...
            overCls: 'Sfr_BtnFormBlue-Hover',
            handler: function () {
                var gridSelected = Ext.getCmp('Koltiva.view.Widget.WinSelectMemberGeneral-MainGrid').getSelectionModel().getSelection();

                var IdSelectedArr = [];
                for (var i = gridSelected.length - 1; i >= 0; i--) {
                    IdSelectedArr.push(gridSelected[i].get('MemberID'));
                }

                if(IdSelectedArr.length > 0){
                    thisObj.viewVar.CompCaller.SelectMemberGeneralMultipleFunc(IdSelectedArr);
                    thisObj.close();
                }else{
                    Ext.MessageBox.show({
                        title: 'Information',
