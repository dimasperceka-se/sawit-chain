...
var contextMenuGrid = Ext.create('Ext.menu.Menu', {
    items: [{
        ...
        text: lang('View'),
        handler: function () {
            var sm = Ext.getCmp('view.GrowerWAGS.GridMainGrower-gridMainGrid').getSelectionModel().getSelection()[0];

            Ext.getCmp('Koltiva.view.GrowerWAGS.GridMainGrower-MainPanel').destroy(); //destory current view
                ...
                if (btn == 'yes') {
                    Ext.Ajax.request({
                        ...
                        success: function (response, opts) {
                            ...
                            //refresh store
                            setFilterLs();
                            Ext.getCmp('view.GrowerWAGS.GridMainGrower-gridMainGrid').getStore().load();
                        },
...
var storeGridMain = Ext.create('Koltiva.store.GrowerWAGS.GridMain');

function setFilterLs() {
    localStorage.setItem('patchouli_grower_ls', JSON.stringify({
        ptextSearch: Ext.getCmp('view.GrowerWAGS.GridMainGrower-textSearch').getValue(),
        ptextSearchDesa: Ext.getCmp('view.GrowerWAGS.GridMainGrower-textSearchDesa').getValue(),
        pCmbRoleSearch: Ext.getCmp('view.GrowerWAGS.GridMainGrower-CmbRoleSearch').getValue(),
        pCmbCategorySearch: Ext.getCmp('view.GrowerWAGS.GridMainGrower-CmbCategorySearch').getValue()
    }));
}
...
function getFilterLs() {
    ...
    if (patchouli_grower_adv_ls != null) {
        ...
        pAdvLastUpdatedDateBegin = patchouli_grower_adv_ls.pAdvLastUpdatedDateBegin;
        pAdvLastUpdatedDateEnd = patchouli_grower_adv_ls.pAdvDateCollectionEnd;
    } else {
        pAdvRowEnumerator = "";
        pAdvTextEnumerator = "";
        pAdvRowHandphone = "";
...
function submitOnEnterGridGrower(field, event) {
    if (event.getKey() == event.ENTER) {
        ...
        if (field.value.length >= 3) {
            Ext.getCmp('view.GrowerWAGS.GridMainGrower-gridMainGrid').getStore().loadPage(1);
        }
    }
}
...
{
    var colFarmerName = Ext.getCmp('view.GrowerWAGS.GridMainGrower-colFarmerName');  
...
Ext.define('Koltiva.view.GrowerWAGS.GridMainGrower', {
    extend: 'Ext.panel.Panel',
    id: 'Koltiva.view.GrowerWAGS.GridMainGrower-MainPanel',
    ...
    listeners: {
        afterRender: function () {
            ...
            var patchouli_grower_ls = JSON.parse(localStorage.getItem('patchouli_grower_ls'));
            if (patchouli_grower_ls != null) {
                Ext.getCmp('view.GrowerWAGS.GridMainGrower-CmbRoleSearch').setValue(patchouli_grower_ls.pCmbRoleSearch);
                // Pake default value dari session (15-01-2020)
                // Ext.getCmp('view.GrowerWAGS.GridMainGrower-textSearch').setValue(patchouli_grower_ls.ptextSearch);
                // Ext.getCmp('view.GrowerWAGS.GridMainGrower-CmbCategorySearch').setValue(patchouli_grower_ls.pCmbCategorySearch);
            }
    ...
    initComponent: function () {
        ...
        thisObj.items = [{
            ...
            items: [{
                ...
                items: [{
                    xtype: 'button',
                    id: 'view.GrowerWAGS.GridMainGrower-btnListView',
                ...
                xtype: 'panel',
                frame: false,
                id: 'view.GrowerWAGS.GridMainGrower-gridInformation',
                html: ''
            }]
        }, {
            xtype: 'grid',
            id: 'view.GrowerWAGS.GridMainGrower-gridMainGrid',
            ...
            dockedItems: [{
                xtype: 'pagingtoolbar',
                id: 'view.GrowerWAGS.GridMainGrower-gridToolbar',
                store: storeGridMain,
                dock: 'bottom',
                displayInfo: true
            }, {
                ...
                items: [{
                    ...
                    {
                        id: 'view.GrowerWAGS.GridMainGrower-CmbCategorySearch',
                        xtype: 'combobox',
                    ...
                    },
                    {
                        ...
                        id: 'view.GrowerWAGS.GridMainGrower-textSearch',
                        xtype: 'textfield',
                        width: 400,
                    ...
                    },
                    {
                        name: 'keyDesa',
                        baseCls: 'Sfr_TxtfieldSearchGrid',
                        id: 'view.GrowerWAGS.GridMainGrower-textSearchDesa',
                        xtype: 'textfield',
                        width: 300,
                        ...
                        id: 'view.GrowerWAGS.GridMainGrower-CmbRoleSearch',
                        xtype: 'combobox',
            ...
            columns: [{
                ...
                id: 'view.GrowerWAGS.GridMainGrower-colid',
                text: lang('ID'),
                dataIndex: 'MemberIDInc',
                hidden: true
            }, {
                id: 'view.GrowerWAGS.GridMainGrower-colPartnerSurvey',
                ...
                id: 'view.GrowerWAGS.GridMainGrower-colFarmerName',
                text: colFarmerName,
                width: '20%',
                dataIndex: 'Name'
            }, {
                id: 'view.GrowerWAGS.GridMainGrower-colSupplyBaseType',
                text: 'Supply Base',
                width: '9%',
                dataIndex: 'SupplybaseType'
            }, {
                id: 'view.GrowerWAGS.GridMainGrower-colBirthdate',
                text: lang('Birthdate'),
                dataIndex: 'Birthdate',
                width: '7%',
                hidden: true
            }, {
                id: 'view.GrowerWAGS.GridMainGrower-colAge',
                text: lang('Age'),
                dataIndex: 'Age',
                width: '3%'
            }, {
                id: 'view.GrowerWAGS.GridMainGrower-colHandphone',
                text: lang('Handphone'),
                dataIndex: 'Handphone',
                width: '7%'
            }, {
                id: 'view.GrowerWAGS.GridMainGrower-colMaritalStatus',
                text: lang('Marital Status'),
                dataIndex: 'MaritalStatus',
                hidden: true
            }, {
                id: 'view.GrowerWAGS.GridMainGrower-colProvince',
                text: lang('Region'),
                dataIndex: 'Province',
                hidden: true
            }, {
                id: 'view.GrowerWAGS.GridMainGrower-colDistrict',
                text: lang('State'),
                dataIndex: 'District',
                hidden: true
            }, {
                id: 'view.GrowerWAGS.GridMainGrower-colKecamatan',
                text: lang('District'),
                width: '10%',
                dataIndex: 'Kecamatan'
            }, {
                id: 'view.GrowerWAGS.GridMainGrower-colDesa',
                text: lang('Village'),
                width: '11%',
                dataIndex: 'Desa'
            }, {
                id: 'view.GrowerWAGS.GridMainGrower-colMill',
                text: lang('Mill'),
                width: '8%',
                dataIndex: 'MillName'
            }, {
                id: 'view.GrowerWAGS.GridMainGrower-colisCertified',
                text: lang('isCertified'),
                width: '8%',
                dataIndex: 'isCertified',
                hidden: m_wags_access_area
            }, {
                id: 'view.GrowerWAGS.GridMainGrower-colNrOfPlantation',
                text: lang('Nr Of Plantation'),
                width: '9%',
                dataIndex: 'NrOfPlantation'
            }, {
                id: 'view.GrowerWAGS.GridMainGrower-colTotalHectare',
                text: lang('Total Hectare'),
                width: '9%',
                dataIndex: 'TotalHectare'
            }, {
                id: 'view.GrowerWAGS.GridMainGrower-colTotalHectarePolygon',
                text: lang('Total Hectare Polygon'),
                width: '9%',
                dataIndex: 'TotalHectarePolygon',
                hidden: true
            }, {
                id: 'view.GrowerWAGS.GridMainGrower-colDateCollection',
                text: lang('Date Collection'),
                width: '7%',
                dataIndex: 'DateCollection'
            }, {
                id: 'view.GrowerWAGS.GridMainGrower-colDateCreated',
                text: lang('Date Created'),
                width: '7%',
                dataIndex: 'DateCreated',
                hidden: true
            }, {
                id: 'view.GrowerWAGS.GridMainGrower-colEnumerator',
