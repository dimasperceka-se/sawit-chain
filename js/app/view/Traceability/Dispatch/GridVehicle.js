Ext.define('Koltiva.view.Traceability.Dispatch.GridVehicle' ,{
    extend: 'Ext.panel.Panel',
    id: 'Koltiva.view.Traceability.Dispatch.GridVehicle',
    initComponent: function() {
        var thisObj = this; 
        //store
		 
        var storeGridVehicle = Ext.create('Koltiva.store.Traceability.Dispatch.MainGridVehicle', {
            storeVar: { 
        ...
        var GridVehicle = Ext.create('Ext.menu.Menu',{
            items:[{
                    ...
                    id: 'Koltiva.view.Traceability.Dispatch.GridVehicle-GridBtnUpdate',
                    handler: function () {

                        var sm = Ext.getCmp('Koltiva.view.Traceability.Dispatch.GridVehicle-Grid').getSelectionModel().getSelection()[0];

                        var FormWinVehicle = Ext.create('Koltiva.view.Traceability.Dispatch.win.FormWinVehicle', {
                            viewVar: {
                    ...
                    text: lang('Delete'),
                    cls:'Sfr_BtnConMenuWhite', 
                    id : 'Koltiva.view.Traceability.Dispatch.GridVehicle-GridBtnDelete',
                    handler: function(){
                        var sm = Ext.getCmp('Koltiva.view.Traceability.Dispatch.GridVehicle-Grid').getSelectionModel().getSelection()[0]; 
        ...
        thisObj.items = [{
            xtype: 'grid',
            id: 'Koltiva.view.Traceability.Dispatch.GridVehicle-Grid', 
            ...
            dockedItems: [{
                ...
                items: [{
                    ...
                    id : 'Koltiva.view.Traceability.Dispatch.addVehicle',
                    handler: function() {
                    ...
                    hidden : thisObj.viewVar.btnVehicle,
                    disabled: false,
                    id : 'Koltiva.view.Traceability.Dispatch.SentVehicle',
                    handler: function() {
                        var sm = Ext.getCmp('Koltiva.view.Traceability.Dispatch.GridVehicle-Grid').getSelectionModel().getSelection()[0]; 
                            ...
                            if (btn == 'yes') {
                                ...
                                Ext.Ajax.request({
                                    ...
                                    success: function(response, opts) {
                                        ...
                                        Ext.getCmp('Koltiva.view.Traceability.Dispatch.addVehicle').setVisible(false);
                                        Ext.getCmp('Koltiva.view.Traceability.Dispatch.SentVehicle').setVisible(false);
                                        Ext.getCmp('Koltiva.view.Traceability.Dispatch.FormMainDispatch-Form-btnSave').setVisible(false);   

                                        Ext.getCmp('Koltiva.view.Traceability.Dispatch.FormMainDispatch-Form-DestpatchStatusID').setValue(5);     
                                        Ext.getCmp('Koltiva.view.Traceability.Dispatch.FormMainDispatch-Form-DestpatchStatusID').setRawValue(lang('Sent'));
            ...
            columns: [{ 
                xtype:'actioncolumn',
                width: 30,
                id :'Koltiva.view.Traceability.Dispatch.GridVehicle-actionColoumn',
                items:[{
