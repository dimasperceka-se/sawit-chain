...
Ext.define('Koltiva.view.Traceability.Supplychain_quality.MainGrid' ,{
    extend: 'Ext.panel.Panel',
    id: 'Koltiva.view.Traceability.Supplychain_quality.MainGrid',  
    initComponent: function() {
        var thisObj = this;
        //store
        var storeGridMain = Ext.create('Koltiva.store.Traceability.Reference.Supplychain_quality.MainGrid');
		...
		var contextMenuQualityGrid = Ext.create('Ext.menu.Menu',{
            ...
            items:[{
                ...
                handler: function() {
                     var sm = Ext.getCmp('Koltiva.view.Traceability.Supplychain_quality.MainGrid-gridMainGrid').getSelectionModel().getSelection()[0];
                ...
                handler: function() {
                        ...
                        var sm = Ext.getCmp('Koltiva.view.Traceability.Supplychain_quality.MainGrid-gridMainGrid').getSelectionModel().getSelection();
                        if (sm[0]) {
            ...
            },
			{
	           icon: varjs.config.base_url + 'images/icons/new/delete.png',
	            ...
	            handler: function(){
						var smb = Ext.getCmp('Koltiva.view.Traceability.Supplychain_quality.MainGrid-gridMainGrid').getSelectionModel().getSelection()[0];
                        RowEditing.cancelEdit();
        ...
        thisObj.items = [{
            xtype: 'grid',
            id: 'Koltiva.view.Traceability.Supplychain_quality.MainGrid-gridMainGrid',
            ...
            dockedItems: [{
                xtype: 'pagingtoolbar',
                id: 'Koltiva.view.Traceability.Supplychain_quality.MainGrid-gridToolbar',
                store: storeGridMain,
                dock: 'bottom',
                displayInfo: true
            },{
                ...
                items: [{
					...
					id:'Koltiva.view.Traceability.Supplychain_quality.MainGrid-gridMainGrid-Btn',
                    handler: function () {
                        RowEditing.cancelEdit();
                        var record = Ext.getCmp('Koltiva.view.Traceability.Supplychain_quality.MainGrid-gridMainGrid').getStore();
...
var MainGridQualityVal = Ext.create('Koltiva.view.Traceability.Supplychain_quality_value.MainGrid'); 
var winQuality = Ext.create('widget.window', {
        title: lang('Quality Value'),
        id:'Koltiva.view.Traceability.Reference.Supplychain_org-winQuality',
        closable: true,
        modal:true,
        closeAction: 'hide',
        autoScroll: true,
...
{
	Ext.getCmp('Koltiva.view.Traceability.Supplychain_quality_value.MainGrid-gridMainGrid').getStore().load({params : { 'QualityID' : QualityID } });
	Ext.getCmp('Koltiva.view.Traceability.Supplychain_quality_value.MainGrid-QualityID').setValue(QualityID);
