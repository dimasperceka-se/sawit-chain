...
Ext.define('Koltiva.view.Trader.TraderVehiclePanel' ,{
    extend: 'Ext.panel.Panel',
    id: 'Koltiva.view.Trader.TraderVehiclePanel',
    title: lang('Vehicle'),
    viewVar: false,
    ...
    initComponent: function() {
        ...
        //store
        var storeGridTraderVehicle = Ext.create('Koltiva.store.Trader.GridTraderVehicle');
        ...
        var contextMenuGridTraderVehicle = Ext.create('Ext.menu.Menu',{
            items:[{
                ...
                text: lang('View'),
                handler: function() {
                    var sm = Ext.getCmp('Koltiva.view.Trader.TraderVehiclePanel-gridTraderVehicle').getSelectionModel().getSelection()[0];

                    var WinFormVehicle = Ext.create('Koltiva.view.Trader.WinFormVehicle');
        ...
        thisObj.items = [{
            xtype: 'grid',
            id: 'Koltiva.view.Trader.TraderVehiclePanel-gridTraderVehicle',
            loadMask: true,
            selType: 'rowmodel',
            minHeight:125,
