 ...
 *  File : MainView.js
 *******************************************/
Ext.define('Koltiva.view.DataAdm.FarmSurveyLocGeo.MainView', {
    extend: 'Ext.panel.Panel',
    id: 'Koltiva.view.DataAdm.FarmSurveyLocGeo.MainView',
    ...
    listeners: {
        afterRender: function () {
            ...
            //render map
            Ext.Ajax.request({
                url: m_api + '/data_adm/farm_survey_loc_geo/render_map',
                method: 'POST',
                params: {
                    ContWidth: Ext.getCmp('Koltiva.view.DataAdm.FarmSurveyLocGeo.MainView-MainMap').getWidth(),
                    ContHeight: Ext.getCmp('Koltiva.view.DataAdm.FarmSurveyLocGeo.MainView-MainMap').getHeight()
                },
                success: function (response) {
                    Ext.MessageBox.hide();
                    var MapReturn = response.responseText;
                    Ext.getCmp('Koltiva.view.DataAdm.FarmSurveyLocGeo.MainView-MainMap').update(MapReturn, true);
                    Ext.getCmp('Koltiva.view.DataAdm.FarmSurveyLocGeo.MainView-MainMap').doLayout();
                },
    ...
    initComponent: function () {
        ...
        //Store
        thisObj.StoreGridCoor = Ext.create('Koltiva.store.DataAdm.FarmSurveyLocGeo.GridCoor', {
            storeVar: {
                FarmerID: null
            }
        });
        thisObj.StoreGridPolygon = Ext.create('Koltiva.store.DataAdm.FarmSurveyLocGeo.GridPolygon', {
            storeVar: {
                FarmerID: null
            }
        });
        ...
        thisObj.ContextMenuCoor = Ext.create('Ext.menu.Menu', {
            items: [{
                    ...
                    hidden: m_act_update,
                    handler: function () {
                        var sm = Ext.getCmp('Koltiva.view.DataAdm.FarmSurveyLocGeo.MainView-GridCoor').getSelectionModel().getSelection()[0];

                        var WinFormUpdateCoor = Ext.create('Koltiva.view.DataAdm.FarmSurveyLocGeo.WinFormUpdateCoor', {
                            viewVar: {
        ...
        thisObj.ContextMenuPolygon = Ext.create('Ext.menu.Menu', {
            items: [{
                    ...
                    hidden: m_act_update,
                    handler: function () {
                        var sm = Ext.getCmp('Koltiva.view.DataAdm.FarmSurveyLocGeo.MainView-GridPolygon').getSelectionModel().getSelection()[0];

                        var WinFormUpdateStatusPoly = Ext.create('Koltiva.view.DataAdm.FarmSurveyLocGeo.WinFormUpdateStatusPoly', {
                            viewVar: {
                                FarmerID: sm.get('FarmerID'),
                                GardenNr: sm.get('GardenNr'),
                                SurveyNr: sm.get('SurveyNr'),
                            ...
                            if (btn == 'yes') {
                                Ext.Ajax.request({
                                    ...
                                    success: function (rp, o) {
                                        ...
                                        Ext.getCmp('Koltiva.view.DataAdm.FarmSurveyLocGeo.MainView-BtnShowData').fireHandler(); //buat trigger click event
                                    },
        ...
        thisObj.items = [{
                ...
                items: [{
                        ...
                        items: [{
                                xtype: 'panel',
                                id: 'Koltiva.view.DataAdm.FarmSurveyLocGeo.MainView-MainMap',
                        ...
                        items: [{
                                ...
                                id:'Koltiva.view.DataAdm.FarmSurveyLocGeo.MainView-PanelSearchFarmer',
                                frame: true,
                                collapsible: true,
                                ...
                                items: [{
                                        ...
                                        items: [{
                                                ...
                                                items: [{
                                                        xtype: 'textfield',
                                                        id: 'Koltiva.view.DataAdm.FarmSurveyLocGeo.MainView-TextFarmerID',
                                                        name: 'Koltiva.view.DataAdm.FarmSurveyLocGeo.MainView-TextFarmerID',
                                                        emptyText: lang('Enter FarmerID here')
                                                    }, {
                                                        xtype: 'button',
                                                        text: lang('Show Data'),
                                                        id: 'Koltiva.view.DataAdm.FarmSurveyLocGeo.MainView-BtnShowData',
                                                        style: 'margin-left:25px;',
                                                        handler: function () {
                                                            //Check apakah ada FarmerID
                                                            var FarmerID = Ext.getCmp('Koltiva.view.DataAdm.FarmSurveyLocGeo.MainView-TextFarmerID').getValue();
                                                            if (FarmerID != '') {
                                                                // Ext.MessageBox.show({
                                                                //     msg: lang('Please wait'),
                                                                //     progressText: lang('Loading'),
                                                                ...
                                                                Ext.Ajax.request({
                                                                    url: m_api + '/data_adm/farm_survey_loc_geo/show_location',
                                                                    method: 'POST',
                                                                    params: {
                                                                        FarmerID: FarmerID
                                                                    },
                                                                    success: function (rp, o) {
                                                                        ...
                                                                        //Set value farmer
                                                                        Ext.getCmp('Koltiva.view.DataAdm.FarmSurveyLocGeo.MainView-FarmerID').setValue(r.data_farmer.FarmerID);
                                                                        Ext.getCmp('Koltiva.view.DataAdm.FarmSurveyLocGeo.MainView-FarmerName').setValue(r.data_farmer.FarmerName);
                                                                        if (r.data_farmer.Gender == '2')
                                                                            Ext.getCmp('Koltiva.view.DataAdm.FarmSurveyLocGeo.MainView-Gender2').setValue(true);
                                                                        else
                                                                            Ext.getCmp('Koltiva.view.DataAdm.FarmSurveyLocGeo.MainView-Gender1').setValue(true);
...
//                                                                            console.log(r.data_koor);
                                                                        ...
                                                                        Ext.MessageBox.hide();
                                                                        Ext.getCmp('Koltiva.view.DataAdm.FarmSurveyLocGeo.MainView-PanelSearchFarmer').collapse();
                                                ...
                                                items: [{
                                                        ...
                                                        readOnly: true,
                                                        id: 'Koltiva.view.DataAdm.FarmSurveyLocGeo.MainView-FarmerID',
                                                        name: 'Koltiva.view.DataAdm.FarmSurveyLocGeo.MainView-FarmerID',
                                                    }, {
                                                        xtype: 'textfield',
                                                        fieldLabel: lang('Name'),
                                                        readOnly: true,
                                                        id: 'Koltiva.view.DataAdm.FarmSurveyLocGeo.MainView-FarmerName',
                                                        name: 'Koltiva.view.DataAdm.FarmSurveyLocGeo.MainView-FarmerName',
                                                    }, {
                                                        xtype: 'radiogroup',
                                                        ...
                                                        items: [{
                                                                boxLabel: lang('Male'),
                                                                name: 'Koltiva.view.DataAdm.FarmSurveyLocGeo.MainView-Gender',
                                                                inputValue: '1',
                                                                id: 'Koltiva.view.DataAdm.FarmSurveyLocGeo.MainView-Gender1',
                                                                listeners: {
                                                                    change: function () {
                                                                        return false;
                                                                    }
                                                                ...
                                                                name: 'Koltiva.view.DataAdm.FarmSurveyLocGeo.MainView-Gender',
                                                                inputValue: '2',
                                                                id: 'Koltiva.view.DataAdm.FarmSurveyLocGeo.MainView-Gender2',
                                                                listeners: {
                                                                    change: function () {
                                                                        return false;
                                                                    }
                                ...
                                xtype: 'grid',
                                id: 'Koltiva.view.DataAdm.FarmSurveyLocGeo.MainView-GridCoor',
                                cls: 'Sfr_GridNew',
                                ...
                                dockedItems: [{
                                        ...
                                        items: [{
                                                text: lang('Check All'),
                                                id: 'Koltiva.view.DataAdm.FarmSurveyLocGeo.MainView-Garden-BtnCheck',
                                                cls: 'Sfr_BtnGridBlue',
                                                ...
                                                id: 'Koltiva.view.DataAdm.FarmSurveyLocGeo.MainView-Garden-BtnUncheck',
                                                cls: 'Sfr_BtnGridRed',
                                ...
                                xtype: 'grid',
                                id: 'Koltiva.view.DataAdm.FarmSurveyLocGeo.MainView-GridPolygon',
                                cls: 'Sfr_GridNew',
                                style: 'border:1px solid #CCC;margin-top:15px;',
                                loadMask: true,
                                selType: 'rowmodel',
                                ...
                                dockedItems: [{
                                        ...
                                        items: [{
                                                text: lang('Check All'),
                                                id: 'Koltiva.view.DataAdm.FarmSurveyLocGeo.MainView-Poly-BtnCheck',
                                                cls: 'Sfr_BtnGridBlue',
                                                overCls: 'Sfr_BtnGridBlue-Hover',
                                                handler: function () {
                                                    var i = 0;
                                                ...
                                                text: lang('Uncheck All'),
                                                id: 'Koltiva.view.DataAdm.FarmSurveyLocGeo.MainView-Poly-BtnUncheck',
                                                cls: 'Sfr_BtnGridRed',
                                                overCls: 'Sfr_BtnGridRed-Hover',
                                                handler: function () {
                                                    var i = 0;
