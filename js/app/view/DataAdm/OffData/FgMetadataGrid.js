...
* @Author: ardiantoro
* @Date:   2022-07-20
* @Last Modified by:   ardiantoro
* @Last Modified time: 2022-07-20
*/
//variabel yg diperlukan
var contextMenuGrid = Ext.create('Koltiva.view.DataAdm.OffData.ContextMenuGridMetadataFg');

Ext.define('Koltiva.view.DataAdm.OffData.FgMetadataGrid' ,{
    extend: 'Ext.grid.Panel',
    id: 'mainGridMetadataFg',
    width: '99.5%',
    ...
    initComponent: function() {
        ...
        //store grid
        objMainGridMetadata.store = Ext.create('Koltiva.store.DataAdm.OffData.MainListMetadataFg');
        ...
        objMainGridMetadata.dockedItems = [{
            ...
            items: [{
                ...
                text: lang('Generate Metadata (FG)'),
                ...
                icon: varjs.config.base_url + 'images/icons/new/add.png', cls:'Sfr_BtnGridGreen', overCls:'Sfr_BtnGridGreen-Hover',
                text: lang('Generate Metadata Development FG'),
