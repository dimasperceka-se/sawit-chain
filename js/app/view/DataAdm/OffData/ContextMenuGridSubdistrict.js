/*
* @Author: nikolius
* @Date:   2017-04-07 16:05:07
* @Last Modified by:   nikolius
* @Last Modified time: 2017-08-18 11:41:28
*/
Ext.define('Koltiva.view.DataAdm.OffData.ContextMenuGridSubdistrict' ,{
    extend: 'Ext.menu.Menu',
    id: 'Koltiva-view-DataAdm-OffData-ContextMenuGridSubdistrict',
    rowData: false,
    ...
    items:[{
        ...
        id: 'Koltiva-view-DataAdm-OffData-ContextMenuGridSubdistrict-generate',
        text: lang('Generate File'),
        hidden: !m_act_offline_data_generate,
        handler: function() {
            var rowData = Ext.getCmp('Koltiva-view-DataAdm-OffData-ContextMenuGridSubdistrict').rowData;
            ...
            Ext.Ajax.request({
                ...
                success: function(data) {
                    Ext.getCmp('mainGridSubdistrict').store.load();
                    Ext.MessageBox.hide();
        ...
        icon: varjs.config.base_url + 'images/icons/new/view.png',
        id: 'Koltiva-view-DataAdm-OffData-ContextMenuGridSubdistrict-download',
