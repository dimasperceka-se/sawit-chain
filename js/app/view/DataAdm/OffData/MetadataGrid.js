...
var contextMenuGrid = Ext.create('Koltiva.view.DataAdm.OffData.ContextMenuGridMetadata');

Ext.define('Koltiva.view.DataAdm.OffData.MetadataGrid' ,{
    ...
    initComponent: function() {
        ...
        //store grid
        objMainGridMetadata.store = Ext.create('Koltiva.store.DataAdm.OffData.MainListMetadata');
        ...
        objMainGridMetadata.dockedItems = [{
            ...
            items: [{
                ...
                text: lang('Generate Metadata (DHIS)'),
