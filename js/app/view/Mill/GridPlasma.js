...
var contextMenuGridMill = Ext.create('Ext.menu.Menu',{
    items:[{
        ...
        hidden: m_act_update,
        handler: function(){
            var sm = Ext.getCmp('Koltiva.view.Mill.Plasma-GridPlasma').getSelectionModel().getSelection()[0];
...
var storeGridPlasma = Ext.create('Koltiva.store.Mill.GridPlasma');
Ext.define('Koltiva.view.Mill.GridPlasma' ,{
    extend: 'Ext.panel.Panel',
    title: lang('Grid Plasma Smallholders (Estate Plasma)'),
    frame: true,
    collapsible:false,
    id: 'Koltiva.view.Mill.GridPlasma',
    margin:'0 0 20 0',
    viewConfig: {
    ...
    initComponent: function() {
        ...
        thisObj.items = [{
            xtype: 'grid',
            id: 'Koltiva.view.Mill.Plasma-GridPlasma',
            loadMask: true,
            minHeight:300,
            style: 'border:1px solid #CCC;margin-top:4px;overflow-x: hidden;',
            selType: 'rowmodel',
            store: storeGridPlasma,
            viewConfig: {
                deferEmptyText: false,
                emptyText: lang('No data Available')
            },
            dockedItems: [{
                xtype: 'pagingtoolbar',
                id: 'Koltiva.view.Mill.GridPlasma-gridToolbar',
                store: storeGridPlasma,
                dock: 'bottom',
                displayInfo: true
            },{
            ...
            columns: [{
                ...
                xtype:'actioncolumn',
                width:70,
                id: 'Koltiva.view.Mill.GridPlasma-Action',
                items:[{
    ...
    listeners: {
        afterRender: function(){
            ...
            if(thisObj.viewVar.opsiDisplay == "view"){
                Ext.getCmp('button_add_data_plasma').destroy();
            }
            
            //load store Document
            var grid_company_owned_estate = Ext.data.StoreManager.lookup('Koltiva.store.Mill.GridPlasma');
