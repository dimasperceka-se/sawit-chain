...
var contextMenuGridMill = Ext.create('Ext.menu.Menu',{
    items:[{
        ...
        hidden: m_act_update,
        handler: function(){
            var sm = Ext.getCmp('Koltiva.view.Mill.CompanyOwnedEstate-GridCompanyOwnedEstate').getSelectionModel().getSelection()[0];
...
var storeGridCompanyOwnedEstate = Ext.create('Koltiva.store.Mill.GridCompanyOwnedEstate');
Ext.define('Koltiva.view.Mill.GridCompanyOwnedEstate' ,{
    extend: 'Ext.panel.Panel',
    title: lang('Grid Company Owned Estates (Estate Inti)'),
    frame: true,
    collapsible:false,
    id: 'Koltiva.view.Mill.GridCompanyOwnedEstate',
    viewConfig: {
    ...
    initComponent: function() {
        ...
        thisObj.items = [{
            xtype: 'grid',
            id: 'Koltiva.view.Mill.CompanyOwnedEstate-GridCompanyOwnedEstate',
            loadMask: true,
            minHeight:300,
            ...
            columns: [{
                ...
                xtype:'actioncolumn',
                width:70,
                id: 'Koltiva.view.Mill.GridCompanyOwnedEstate-Action',
                items:[{
    ...
    listeners: {
        afterRender: function(){
            ...
            //load store Document
            var grid_company_owned_estate = Ext.data.StoreManager.lookup('Koltiva.store.Mill.GridCompanyOwnedEstate');
