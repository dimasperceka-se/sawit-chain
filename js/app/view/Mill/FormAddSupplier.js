...
Ext.define('Koltiva.view.Mill.FormAddSupplier' ,{
    extend: 'Ext.window.Window',
    id: 'Koltiva.view.Mill.FormAddSupplier',
    ...
    initComponent: function() {
        ...
        var ContactRecords = [];
        var OldID = [];
        var OldContactRecords = Ext.getCmp('Koltiva.view.Mill.FormTracebilityDeclarationManual-gridSupplier').getStore().data.items;
        ...
        thisObj.items = [{
            xtype: 'form',
            id: 'Koltiva.view.Mill.FormAddSupplier-Form',
            padding:'5 8 5 8',
            items:[{
                layout: 'column',
                border: false,
                items:[{
                    ...
                    items:[{
                        ...
                        items:[{
                            ...
                            items:[{
                                name: 'SupplierName',
                                id: 'Koltiva.view.Mill.FormAddSupplier-SupplierName',
                                xtype: 'textfield',
                                ...
                                xtype: 'combobox',
                                id: 'Koltiva.view.Mill.FormAddSupplier-KategoriKebun',
                                name: 'KategoriKebun',
                            ...
                            items:[{
                                name: 'FFBSupply',
                                id: 'Koltiva.view.Mill.FormAddSupplier-FFBSupply',
                                xtype: 'numberfield',
                                ...
                                name: 'Tracebility',
                                id: 'Koltiva.view.Mill.FormAddSupplier-Tracebility',
                                xtype: 'numberfield',
            ...
            listeners: {
                afterrender: function(){
                    if(thisObj.formVar.opsiDisplay == 'insert'){
                        //form reset
                        Ext.getCmp('Koltiva.view.Mill.FormAddSupplier-Form').getForm().reset();
                    }
                }
            }
        }];
        ...
        thisObj.buttons = [{
            ...
            ui: 's-button',
            cls: 's-blue',
            id: 'Koltiva.view.Mill.FormAddSupplier-Form-BtnSave',
            handler: function () {
                var formSelectContact = Ext.getCmp('Koltiva.view.Mill.FormAddSupplier-Form').getForm();
                if (formSelectContact.isValid()) {
                    var SupplierName = Ext.getCmp('Koltiva.view.Mill.FormAddSupplier-SupplierName').getValue();
                    var KategoriKebun = Ext.getCmp('Koltiva.view.Mill.FormAddSupplier-KategoriKebun').getValue();
                    var Tracebility = Ext.getCmp('Koltiva.view.Mill.FormAddSupplier-Tracebility').getValue();
                    var FFBSupply = Ext.getCmp('Koltiva.view.Mill.FormAddSupplier-FFBSupply').getValue();
                    ...
                    Ext.getCmp('Koltiva.view.Mill.FormTracebilityDeclarationManual-gridSupplier').getStore().loadData(ContactRecords);
                    thisObj.close();
