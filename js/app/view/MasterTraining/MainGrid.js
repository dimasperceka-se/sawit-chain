function submitOnEnter(field, event){
    if (event.getKey() == event.ENTER) {
        setFilterLs();
        Ext.getCmp('Koltiva.view.MasterTraining.MainGrid-Grid').getStore().loadPage(1);
    }
}
...
function setFilterLs(){
    localStorage.setItem('patchouli_farmergroup_ls',
        JSON.stringify({
            ptextSearch: Ext.getCmp('Koltiva.view.MasterTraining.MainGrid-textSearch').getValue()
        })
    );
}

Ext.define('Koltiva.view.MasterTraining.MainGrid' ,{
    extend: 'Ext.panel.Panel',
    id: 'Koltiva.view.MasterTraining.MainGrid',
    ...
    listeners: {
        afterRender: function(){
            ...
            setFilterLs();
            Ext.getCmp('Koltiva.view.MasterTraining.MainGrid-Grid').getStore().load();
        }
    },
    initComponent: function() {
        ...
        //store
        thisObj.storeMainGrid = Ext.create('Koltiva.store.MasterTraining.MainGrid');
        ...
        thisObj.contextMenuMainGrid = Ext.create('Ext.menu.Menu',{
            items:[{
                ...
                text: lang('View'),
                handler: function() {
                    var sm = Ext.getCmp('Koltiva.view.MasterTraining.MainGrid-Grid').getSelectionModel().getSelection()[0];

                    Ext.getCmp('Koltiva.view.MasterTraining.MainGrid').destroy(); //destory current view
                    var MainForm = [];

                    //create object View
                    if(Ext.getCmp('Koltiva.view.MasterTraining.MainForm') == undefined){
                        MainForm = Ext.create('Koltiva.view.MasterTraining.MainForm', {
                            viewVar: {
                                opsiDisplay: 'view',
        ...
        thisObj.items = [{
            ...
            items: [{
                ...
                xtype: 'panel',
                frame: false,
                id: 'Koltiva.view.MasterTraining.MainGrid-gridInformation',
                html: ''
            }]
        },{
            xtype: 'grid',
            id: 'Koltiva.view.MasterTraining.MainGrid-Grid',
            ...
            dockedItems: [{
                ...
                items: [{
                    ...
                    id: 'Koltiva.view.MasterTraining.MainGrid-textSearch',
                    xtype: 'textfield',
                    width: 400,
                    ...
                    handler: function() {
                        var WinApplyFilter = Ext.create('Koltiva.view.MasterTraining.WinApplyFilter', {
                            viewVar: {
