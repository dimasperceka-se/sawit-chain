 ...
 *  File : PlotSurPanelSummaryGarCertification.js
 *******************************************/
...
Ext.define('Koltiva.view.PlotSurvey.PlotSurPanelSummaryGarCertification' ,{
    extend: 'Ext.panel.Panel',
    id: 'Koltiva.view.PlotSurvey.PlotSurPanelSummaryGarCertification',
    title: lang('Plantation Surveys Certification'),
    viewVar: false,
    ...
    listeners: {
        ...
        expand: function() {
            var thisObj = this;
            thisObj.storeGridPlotSurvey.setStoreVar({MemberID:thisObj.viewVar.MemberID, from : 'certification'});
    ...
    initComponent: function() {
        ...
        var contextMenuGridPlotSurvey = Ext.create('Ext.menu.Menu',{
            items:[{
                ...
                text: lang('View'),
                handler: function() {
                    var sm = Ext.getCmp('Koltiva.view.Grower.PlotSurvey.PlotSurPanelSummaryCertification-gridPlotSurvey').getSelectionModel().getSelection()[0];

                    //window form plot survey
                    var winFormPlotSurvey = Ext.create('Koltiva.view.PlotSurvey.WinFormPlotSurveyGarCertification');
        ...
        thisObj.items = [{
            xtype: 'grid',
            id: 'Koltiva.view.Grower.PlotSurvey.PlotSurPanelSummaryCertification-gridPlotSurvey',
            loadMask: true,
            selType: 'rowmodel',
            minHeight:'200',
