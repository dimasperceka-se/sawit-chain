...
Ext.define('Koltiva.view.PlotSurvey.WinFormPlotSurveySta' ,{
                        ...
                        items:[{
                            ...
                            items:[{
                                ...
                                items:[{
                                    ...
                                    xtype: 'label', margin:0, padding:0, padding:5, columns:2, cls: 'x-form-item-label', html:'<div class="companyLabel">'+lang('Plantation Boarders')+'</div>'
                                },{
                                    xtype: 'textfield',
                                    ...
                                    items:[{
                                        ...
                                        items:[{
                                            xtype:'label',
                                            cls: 'x-form-item-label',
                                            text: lang('Who created/planted the plantation')
                                        }]
                                    }]
                                },{
                                    layout: 'column',
                                    ...
                                    items:[{
                                        ...
                                        items:[{
                                            ...
                                            items:[{
                                                boxLabel: lang('Group'),
                                                name: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-PlantingType',
                                                inputValue: '1',
                                                id: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-PlantingType1',
                                                listeners:{
                                                    change: function(){
                                                        return false;
                                                    }
                                                ...
                                                name: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-PlantingType',
                                                inputValue: '3',
                                                id: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-PlantingType3',
                                                listeners:{
                                                    change: function(){
                                                        return false;
                                                    }
                                            ...
                                            defaultType: 'radiofield',
                                            items:[{
                                                boxLabel: lang('The owner themselves'),
                                                name: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-PlantingType',
                                                inputValue: '2',
                                                id: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-PlantingType2',
                                                listeners:{
                                                    change: function(){
                                                        return false;
                                                    }
                                    ...
                                    items:[{
                                        ...
                                        items:[{
                                            xtype:'label',
                                            cls: 'x-form-item-label',
                                            text: lang('Who manages the plantation')
                                        }]
                                    }]
                                },{
                                    layout: 'column',
                                    ...
                                    items:[{
                                        ...
                                        items:[{
                                            ...
                                            items:[{
                                                boxLabel: lang('Group'),
                                                name: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-ManageType',
                                                inputValue: '1',
                                                id: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-ManageType1',
                                                listeners:{
                                                    change: function(){
                                                        return false;
                                                    }
                                                ...
                                                name: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-ManageType',
                                                inputValue: '3',
                                                id: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-ManageType3',
                                                listeners:{
                                                    change: function(){
                                                        return false;
                                                    }
                                            ...
                                            items:[{
                                                ...
                                                name: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-ManageType',
                                                inputValue: '2',
                                                id: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-ManageType2',
                                                listeners:{
                                                    change: function(){
                                                        return false;
                                                    }
                                ...
                                items:[{
                                    ...
                                    xtype: 'numericfield',
                                    id: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-PercentagDura',
                                    name: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-PercentagDura',
                                    fieldLabel: lang('Percentag eof dura variety'),
                                    labelWidth: 175,
                                    allowNegative: false,
                                    minValue: 0
                                },{
                                    ...
                                    items:[{
                                        ...
                                        items:[{
                                            ...
                                            items:[{
                                                boxLabel: lang('Farm'),
                                                name: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-TPHLoc',
                                                inputValue: '1',
                                                id: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-TPHLoc1',
                                                listeners:{
                                                    change: function(){
                                                        return false;
                                                    }
                                            ...
                                            items:[{
                                                ...
                                                name: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-TPHLoc',
                                                inputValue: '2',
                                                id: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-TPHLoc2',
                                                listeners:{
                                                    change: function(){
                                                        return false;
                                                    }
                                    ...
                                    xtype: 'label', margin:0, padding:0, padding:5, columns:2, cls: 'x-form-item-label', html:'<div class="companyLabel">'+lang('TBS Supply Area Coverage')+'</div>'
                                },{
                                    xtype: 'combobox',
                                    id: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-ProvinceIDTPH',
                                    name: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-ProvinceIDTPH',
                                    store: thisObj.cmb_province,
                                    fieldLabel: lang('Province'),
                                    queryMode: 'local',
                                    displayField: 'label',
                                    ...
                                    listeners: {
                                        change: function(cb, nv, ov) {
                                            ...
                                            Ext.getCmp('Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-DistrictIDTPH').setValue('');
                                            Ext.getCmp('Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-SubDistrictIDTPH').setValue('');
                                        }
                                    }
                                },{
                                    xtype: 'combobox',
                                    id: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-DistrictIDTPH',
                                    name: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-DistrictIDTPH',
                                    store: thisObj.cmb_district,
                                    fieldLabel: lang('District'),
                                    queryMode: 'local',
                                    displayField: 'label',
                                    ...
                                    xtype: 'combobox',
                                    id: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-SubDistrictIDTPH',
                                    name: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-SubDistrictIDTPH',
                                    store: thisObj.cmb_subdistrict,
                                    fieldLabel: lang('Subdistrict'),
                                    allowBlank: false,
                                    queryMode: 'local',
                                    ...
                                    xtype: 'numericfield',
                                    id: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-Distance',
                                    name: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-Distance',
                                    fieldLabel: lang('Distance from plantation to mill (km)'),
                                    labelWidth: 275,
                                    allowNegative: true,
                                    minValue: 0
                                },{
                            ...
                            items:[{
                                    ...
                                    items: [{
                                            ...
                                            items:[{
                                                    ...
                                                    listeners: {
                                                        'change': function (fb, v) {
                                                            if (thisObj.viewVar.User == 'Farmer') {
                                                                var link = '/images/plot_farm/';
                                                            } else if (thisObj.viewVar.User == 'SME') {
                                                                var link = '/images/plot_farm_sme/';
                                                            }
                                                            Ext.getCmp('Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form').getForm().submit({
                                            ...
                                            items:[{
                                                ...
                                                items:[{
                                                    ...
                                                    items:[{
                                                        ...
                                                        items:[{
                                                            boxLabel: lang('Farm'),
                                                            name: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-PresentedBy',
                                                            inputValue: '1',
                                                            id: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-PresentedBy1',
                                                            listeners:{
                                                                change: function(){
                                                                    return false;
                                                                }
                                                        ...
                                                        items:[{
                                                            ...
                                                            name: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-PresentedBy',
                                                            inputValue: '2',
                                                            id: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-PresentedBy2',
                                                            listeners:{
                                                                change: function(){
                                                                    return false;
                                                                }
                                                ...
                                                items:[{
                                                        ...
                                                        items:[{
                                                            xtype: 'image',
                                                            id: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-Signature',
                                                            width: '300px',
                                                            height:'200px',
                                                            src: m_api_base_url + '/images/no-image-icon.png'
                                                        },{
                                                            xtype: 'textfield',
                                                            id: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-SignatureOld',
                                                            name: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-SignatureOld',
                                                            inputType: 'hidden'
                                                        }]
                                                    }]
                                            },{
                                                    ...
                                                    labelWidth: 230,
                                                    id: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-SignatureInput',
                                                    name: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-SignatureInput',
                                                    buttonText: 'Browse',
                                                    listeners: {
                                                        'change': function (fb, v) {
                                                            if (thisObj.viewVar.User == 'Farmer') {
                                                                var link = '/images/plot_signature/';
                                                            } else if (thisObj.viewVar.User == 'SME') {
                                                                var link = '/images/plot_signature_sme/';
                                                            }
                                                            Ext.getCmp('Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form').getForm().submit({
                                                                url: m_api + '/plot_survey/photo_signature',
                                                                clientValidation: false,
                                                                params: {
                                                                    opsiDisplay: thisObj.viewVar.opsiDisplay,
                                                                    MemberID: thisObj.viewVar.MemberID,
                                                                ...
                                                                waitMsg: 'Sending Photo...',
                                                                success: function (fp, o) {
                                                                    Ext.getCmp('Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-Signature').setSrc(m_api_base_url + link + o.result.file);
                                                                    Ext.getCmp('Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-SignatureOld').setValue(o.result.file);
                                                                }
                                                            });
                                                        }
                                                    }
...
//                    Ext.getCmp('Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-TypePlantMateTotalTreeNr').removeCls('notif-red');
                ...
                if (formValidOrNot ==  true) {
                        if (thisObj.viewVar.User == 'Farmer') {
                            var link = '/plot_survey/survey';
                        } else if (thisObj.viewVar.User == 'SME') {
                            var link = '/sme/trader_survey_sta';
                        }
                    formNya.submit({
                        url: m_api + link,
                        method:'POST',
    ...
    listeners: {
        afterRender: function(){
            ...
            if(thisObj.viewVar.opsiDisplay == 'update' || thisObj.viewVar.opsiDisplay == 'view'){
                ...
                if (thisObj.viewVar.User == 'Farmer') {
                    var link = '/plot_survey/plot_survey_form_data';
                } else if (thisObj.viewVar.User == 'SME') {
                    var link = '/sme/trader_survey_sta_form_data';
                }
                ...
                Ext.Ajax.request({
                    ...
                    params: {MemberID:  thisObj.viewVar.MemberID},
                    success: function(response, opts){
                        console.log("sta"+thisObj.viewVar.User);
                        var r = Ext.decode(response.responseText);
                        ...
                        var ProvinceID = r.data.ProvinceID
                        ...
                        formNya.getForm().load({
                            ...
                            success: function(form, action) {
                                ...
                                thisObj.cmb_province.load({
                                    callback: function(records, operation, success){
                                        Ext.getCmp('Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-ProvinceIDTPH').setValue(r.data.ProvinceIDTPH);
                                        if (success == true) {
                                            thisObj.cmb_district.load({
                                                params: {
                                                    ProvinceID: r.data.ProvinceIDTPH
                                                },
                                                callback: function(records, operation, success){
                                                    if (success == true) {
                                                        Ext.getCmp('Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-DistrictIDTPH').setValue(r.data.DistrictIDTPH);
                                                        thisObj.cmb_subdistrict.load({
                                                            params: {
                                                                DistrictID: r.data.DistrictIDTPH
                                                            },
                                                            callback: function(records, operation, success){
                                                                if (success == true) {
                                                                    Ext.getCmp('Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-SubDistrictIDTPH').setValue(r.data.SubDistrictIDTPH);
                                ...
                                if(r.data.Signature != ""){
                                    ...
                                    var Signature = m_api_base_url + link +ProvinceID+'/'+r.data.MemberDisplayID+'/'+ r.data.Signature;
                                    console.log(Signature);
                                    checkImageExists(Signature, function(existsImage) {
                                        if (existsImage == true) {
                                            Ext.getCmp('Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-Signature').setSrc(Signature);
                                        } else {
                                            Ext.getCmp('Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-Signature').setSrc(m_api_base_url + '/images/no-image-icon.png');
                                        }
                                    });
                                }
