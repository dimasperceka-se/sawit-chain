...
Ext.define('Koltiva.view.PlotSurvey.WinFormPlotSurveyWags' ,{
    ...
    initComponent: function() {
        ...
        var cmb_plantation_stage = Ext.create('Koltiva.store.PlotSurvey.CmbPlantationStage');
                    ...
                    items:[{
                        ...
                        items:[{
                            ...
                            items:[{
                                ...
                                layout:'form',
                                items:[{
                                    html:'<div style="margin-top:-7px;" class="subtitleForm">'+lang('Certification')+'</div>'
                                },{
                                    ...
                                    items: [{
                                        boxLabel: lang('Ya'),
                                        name: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-WagsCert',
                                        inputValue: '1',
                                        id: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-WagsCert1',
                                        listeners:{
                                            change: function(){
                                                return false;
                                            }
                                        ...
                                        name: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-WagsCert',
                                        inputValue: '2',
                                        id: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-WagsCert2',
                                        listeners:{
                                            change: function(){
                                                return false;
                                            }
                                    ...
                                    xtype: 'checkboxgroup',
                                    fieldLabel: lang('Certification standard'),
                                    labelWidth: 260,
                                    columns: 2,
                                    items:[{
                                        boxLabel: lang('RSPO'),
                                        name: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-WagsCertStandardRSPO',
                                        inputValue: '1',
                                        id: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-WagsCertStandardRSPO',
                                        listeners:{
                                            change: function(){
                                                return false;
                                            }
                                        ...
                                        boxLabel: lang('MSPO'),
                                        name: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-WagsCertStandardMSPO',
                                        inputValue: '1',
                                        id: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-WagsCertStandardMSPO',
                                        listeners:{
                                            change: function(){
                                                return false;
                                            }
                                    ...
                                    xtype: 'combobox',
                                    id: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-WagsPlantationStage',
                                    name: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-WagsPlantationStage',
                                    store: cmb_plantation_stage,
                                    fieldLabel: lang('Plantation stage'),
                                    queryMode: 'local',
                                    displayField: 'label',
                                    valueField: 'id'
                                },{
                                    ...
                                    items:[{
                                        ...
                                        items:[{
                                            ...
                                            defaultType: 'radiofield',
                                            items:[{
                                                boxLabel: lang('Agriculture - Mixed'),
                                                name: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-WagsCondEstPlantation',
                                                inputValue: '1',
                                                id: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-WagsCondEstPlantation1',
                                                listeners:{
                                                    change: function(){
                                                        return false;
                                                    }
                                                ...
                                                boxLabel: lang('Non-Agriculture'),
                                                name: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-WagsCondEstPlantation',
                                                inputValue: '3',
                                                id: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-WagsCondEstPlantation3',
                                                listeners:{
                                                    change: function(){
                                                        return false;
                                                    }
                                            ...
                                            defaultType: 'radiofield',
                                            items:[{
                                                boxLabel: lang('Agriculture - Oil Palm'),
                                                name: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-WagsCondEstPlantation',
                                                inputValue: '2',
                                                id: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-WagsCondEstPlantation2',
                                                listeners:{
                                                    change: function(){
                                                        return false;
                                                    }
                                                ...
                                                name: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-WagsCondEstPlantation',
                                                inputValue: '4',
                                                id: 'Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-WagsCondEstPlantation4',
                                                listeners:{
                                                    change: function(){
                                                        return false;
                                                    }
...
//                    Ext.getCmp('Koltiva.view.PlotSurvey.WinFormPlotSurvey-Form-TypePlantMateTotalTreeNr').removeCls('notif-red');
                ...
                if(HarvestRateDaysHighSeason < 7 || HarvestRateDaysHighSeason > 30) {
                    formValidOrNot = false;
                    labelNotValid = labelNotValid+'<br />* '+lang('Harvest rate (once every … Days) in high season')+':'+lang('min: 7, max: 30')+'<br />';
                ...
                if(HarvestRateDaysLowSeason < 7 || HarvestRateDaysLowSeason > 30) {
                    formValidOrNot = false;
                    labelNotValid = labelNotValid+'<br />* '+lang('Harvest rate (once every … Days) in low season')+':'+lang('min: 7, max: 30')+'<br />';
