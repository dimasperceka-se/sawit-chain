 ...
 *  File : PlotSurPanelSummaryWags.js
 *******************************************/
...
Ext.define('Koltiva.view.PlotSurvey.PlotSurPanelSummaryWags' ,{
    extend: 'Ext.panel.Panel',
    id: 'Koltiva.view.PlotSurvey.PlotSurPanelSummaryWags',
        ...
        var contextMenuGridPlotSurvey = Ext.create('Ext.menu.Menu',{
            items:[{
                ...
                handler: function() {
                    ...
                    var winFormPlotSurvey = Ext.create('Koltiva.view.PlotSurvey.WinFormPlotSurveyWags');
