Ext.define('Koltiva.view.Basic.MillRefinery.TreeGrid', {
    ...
    requires: [
        ...
        'Ext.tree.*',
        // 'Ext.ux.CheckColumn',
        'Koltiva.model.Basic.MillRefinery.List',
        'Koltiva.view.Basic.MillRefinery.Form',
    ],    
    xtype: 'tree-grid',
    ...
    initComponent: function() {
        Ext.apply(this, {
            store: Ext.create('Koltiva.store.Basic.MillRefinery.List'),
            dockedItems: [{
                xtype: 'toolbar',
                dock:'top',
                items: [{
                    ...
                    handler: function() {
                        ...
                        Ext.Ajax.request({
                            url: m_api+'/report_mill_refinery/export_excel',
    ...
    onViewClick: function() {
        ...
        var frm = Ext.create('Koltiva.view.Basic.MillRefinery.Form');
