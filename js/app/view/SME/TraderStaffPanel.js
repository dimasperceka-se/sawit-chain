...
Ext.define('Koltiva.view.SME.TraderStaffPanel' ,{
    extend: 'Ext.panel.Panel',
    id: 'Koltiva.view.SME.TraderStaffPanel',
    title: lang('Business Employee'),
    viewVar: false,
    ...
    initComponent: function() {
        ...
        //store
        var storeGridTraderStaff = Ext.create('Koltiva.store.SME.GridTraderStaff');
        ...
        var contextMenuGridTraderStaff = Ext.create('Ext.menu.Menu',{
            items:[{
                ...
                text: lang('View'),
                handler: function() {
                    var sm = Ext.getCmp('Koltiva.view.SME.TraderStaffPanel-gridTraderStaff').getSelectionModel().getSelection()[0];
        ...
        thisObj.items = [{
            xtype: 'grid',
            id: 'Koltiva.view.SME.TraderStaffPanel-gridTraderStaff',
            loadMask: true,
            minHeight:125,
            selType: 'rowmodel',
