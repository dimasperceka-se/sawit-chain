Ext.define('Koltiva.view.Traceability_new.Transaction_neo.PanelDataUnitNonFarmer', {
    extend: 'Ext.panel.Panel',
    id: 'Koltiva.view.Traceability_new.Transaction_neo.PanelDataUnitNonFarmer',
    ...
    initComponent: function () {
        ...
        thisObj.ContextMenu = Ext.create('Ext.menu.Menu', {
            ...
            items: [{
                ...
                handler: function () {
                    ...
                    var sm = Ext.getCmp('Koltiva.view.Traceability_new.Transaction_neo.PanelDataUnitNonFarmer-MainGrid').getSelectionModel().getSelection()[0];
        ...
        thisObj.items = [{
            xtype: 'grid',
            id: 'Koltiva.view.Traceability_new.Transaction_neo.PanelDataUnitNonFarmer-MainGrid',
            cls: 'Sfr_GridNew',
            loadMask: true,
            height: 300,
            selType: 'rowmodel',
            ...
            dockedItems: [{
                ...
                dock: 'top',
                items: [{
                    id: 'Koltiva.view.Traceability_new.Transaction_neo.PanelDataUnitNonFarmer-ButtonAdd',
                    xtype: 'button',
            ...
            columns: [{
                id: 'Koltiva.view.Traceability_new.Transaction_neo.PanelDataUnitNonFarmer-ButtonActionGrid',
                text: ' ',
                xtype: 'actioncolumn',
                width: '10%',
                items: [{
        ...
        thisObj.MainGrid.on('load', function(store, records){
            ...
            if (Ext.getCmp('Koltiva.view.Traceability_new.Transaction_neo.MainForm-FormBasicData-TotalPaymentNonFarmer').getValue() === null) {
                Ext.getCmp('Koltiva.view.Traceability_new.Transaction_neo.MainForm-FormBasicData-TotalPaymentNonFarmer').setValue(0);
            }

            if (records.length > 0) {
                Ext.getCmp('Koltiva.view.Traceability_new.Transaction_neo.PanelDataUnitNonFarmer-ButtonAdd').hide()
            }
        
            Ext.getCmp('Koltiva.view.Traceability_new.Transaction_neo.MainForm-FormBasicData-TotalPaymentNonFarmer').setValue(parseFloat(store.sum('TotalPayment')));
