Ext.define('Koltiva.view.Traceability_new.Transaction_neo.PaymentInstuction' ,{
    extend: 'Ext.window.Window',
    id: 'Koltiva.view.Traceability_new.Transaction_neo.PaymentInstuction',
    ...
    initComponent: function() {
        ...
        thisObj.items = [
            ...
            xtype: 'form',
            frame: true,
            id: 'Koltiva.view.Traceability_new.Transaction_neo.PaymentInstuction-form',
            frame: false,
            width: '60%',
            height: 450,
            autoScroll:true,
