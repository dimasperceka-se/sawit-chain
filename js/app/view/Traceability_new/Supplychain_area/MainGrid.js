...
Ext.define('Koltiva.view.Traceability_new.Supplychain_area.MainGrid' ,{
    extend: 'Ext.panel.Panel',
    id: 'Koltiva.view.Traceability_new.Supplychain_area.MainGrid',  
    initComponent: function() {
        ...
        //store 
		 ...
		 var storeGridMainAreaDistrict = Ext.create('Koltiva.store.Traceability_new.Reference.Supplychain_area.MainGrid');
        //items
		...
		var contextMenuAreaGrid = Ext.create('Ext.menu.Menu',{
            ...
            items:[ {
                ...
                text: lang('Update'),
                itemId: 'Koltiva.view.Traceability_new.Transaction.List_transactionArea-contextMenuUpdateItem',
                //hidden: m_act_update,
                handler: function() {
						RowEditing.cancelEdit();
                        var sm = Ext.getCmp('Koltiva.view.Traceability_new.Supplychain_area.MainGrid-gridMainGrid').getSelectionModel().getSelection();
                        if (sm[0]) {
            ...
            },
			{
	            ...
	            handler: function(){
						var smb = Ext.getCmp('Koltiva.view.Traceability_new.Supplychain_area.MainGrid-gridMainGrid').getSelectionModel().getSelection()[0];
                        RowEditing.cancelEdit();
                            ...
                            Ext.MessageBox.confirm('Message', lang('Are you sure will delete this data ?'), function (btn) {
                                if (btn == 'yes') {
                                    Ext.Ajax.request({
                                        ...
                                        url: m_api + '/traceability_api/Supplychain_area/del/' + smb.raw.SupplychainAreaID, 
                                        method: 'DELETE',
        ...
        thisObj.items = [{
            xtype: 'grid',
            id: 'Koltiva.view.Traceability_new.Supplychain_area.MainGrid-gridMainGrid',
            ...
            dockedItems: [{
                xtype: 'pagingtoolbar',
                id: 'Koltiva.view.Traceability_new.Supplychain_area.MainGrid-gridToolbar',
                store: storeGridMainAreaDistrict,
                dock: 'bottom',
                displayInfo: true
            },{
                ...
                items: [{
					...
					id :'Koltiva.view.Traceability_new.Supplychain_area.MainGrid-gridMainGrid-Btn',
                    handler: function () { 
						
						RowEditing.cancelEdit();
                        var record = Ext.getCmp('Koltiva.view.Traceability_new.Supplychain_area.MainGrid-gridMainGrid').getStore();
            ...
            listeners: { 
                ...
                'edit': function (editor, e) { 
                    ...
                    var DistrictID = e.record.data.DistrictID;
                    var District = e.record.data.District;
					...
					if(Ext.getCmp('setVarParameters').getValue() != 'view'){
						Ext.Ajax.request({
							waitMsg: lang('Please wait...'),
							url: m_api + '/traceability_api/Supplychain_area/submit',
							method: 'POST',
							params: {
