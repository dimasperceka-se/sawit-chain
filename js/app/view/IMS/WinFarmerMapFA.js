...
Ext.define('Koltiva.view.IMS.WinFarmerMapFA' ,{
    extend: 'Ext.window.Window',
    id: 'Koltiva.view.IMS.WinFarmerMapFA',
    title: lang('Coaching Mapping per Field Agents (FA)'),
    closable: true,
    modal: true,
    closeAction: 'destroy',
    width: '94%',
    ...
    initComponent: function() {
        ...
        //STORE
        thisObj.StoreGridMappingFA = Ext.create('Koltiva.store.IMS.GridMappingFAFarmer', {
            storeVar: {
                IMSID: thisObj.viewVar.IMSID
            }
        });
        thisObj.StoreCmbFilterFA = Ext.create('Koltiva.store.IMS.CmbFilterFAMapping', {
            storeVar: {
                IMSID: thisObj.viewVar.IMSID
            }
        });
        ...
        thisObj.items = [{
                ...
                items: [{
                        xtype: 'form',
                        id: 'Koltiva.view.IMS.WinFarmerMapFA-Form',
                        fieldDefaults: {
                            labelAlign: 'left',
                            labelWidth: 250
                        },
                        ...
                        items: [{
                                ...
                                labelWidth: 125,
                                id: 'Koltiva.view.IMS.WinFarmerMapFA-Form-FileImport',
                                name: 'FileImport',
                                buttonText: lang('Browse'),
                                allowBlank: false,
                                listeners: {
                                    'change': function (fb, v) {
                                        var form = Ext.getCmp('Koltiva.view.IMS.WinFarmerMapFA-Form').getForm();
                                        form.submit({
                                            url: m_api + '/ims/import_farmer_mapping_fa',
                                ...
                                html: '<a style="text-decoration:underline;" href="' + varjs.config.base_url + 'api/ims/ims_farmer_mapping/' + thisObj.viewVar.IMSID + '" target="_blank">Download Template File for Import</a>'
                            }]
                    }]
            }, {
                xtype: 'gridpanel',
                title: lang('Candidate'),
                id: 'Koltiva.view.IMS.WinFarmerMapFA-Grid',
                ...
                dockedItems: [{
                        ...
                        items: [{
                                xtype: 'combobox',
                                id: 'Koltiva.view.IMS.WinFarmerMapFA-Grid-CmbFilterFA',
                                name: 'Koltiva.view.IMS.WinFarmerMapFA-Grid-CmbFilterFA',
                                ...
                                handler: function () {
                                    ...
                                    var FilterFA = Ext.getCmp('Koltiva.view.IMS.WinFarmerMapFA-Grid-CmbFilterFA').getValue();
