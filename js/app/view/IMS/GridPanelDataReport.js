Ext.define('Koltiva.view.IMS.GridPanelDataReport' ,{
    extend: 'Ext.panel.Panel',
    id: 'Koltiva.view.IMS.GridPanelDataReport',
    initComponent: function() {
        ...
        cmb_report_tools.proxy.extraParams = { type: 'report'};
        ...
        thisObj.items = [{
            ...
            items:[{
                ...
                items:[{
                    ...
                    displayField: 'label',
                    valueField: 'id',
                    id: 'Koltiva.view.IMS.GridPanelDataReport-Tab-SummaryData-SummaryOption',
                    name: 'Koltiva.view.IMS.GridPanelDataReport-Tab-SummaryData-SummaryOption',
                    editable: false,
                    ...
                    handler: function() {
                        thisObj.SummaryShowData(Ext.getCmp('Koltiva.view.IMS.GridPanelDataReport-Tab-SummaryData-SummaryOption').getValue());
                    }
                }]
            },{
                columnWidth: 1,
                ...
                items:[{
                    xtype: 'grid',
                    id: 'Koltiva.view.IMS.GridPanelDataReport-Tab-SummaryData-GridData',
                    ...
                    dockedItems: [{
                        xtype: 'pagingtoolbar',
                        id:'Koltiva.view.IMS.GridPanelDataReport-Tab-SummaryData-GridData-PagingToolbar',
                        ...
                        items: [{
                            ...
                            handler: function() {
                                ...
                                Ext.Ajax.request({
                                    ...
                                    params: {                                        
                                        RepID: Ext.getCmp('Koltiva.view.IMS.GridPanelDataReport-Tab-SummaryData-SummaryOption').getValue(),
                                        IMSID: thisObj.IMSID
                                    },
    ...
    SummaryShowData: function(RepID){
        var thisObj = this;
        var GridSummary = Ext.getCmp('Koltiva.view.IMS.GridPanelDataReport-Tab-SummaryData-GridData');
        var GridSummaryToolbar = Ext.getCmp('Koltiva.view.IMS.GridPanelDataReport-Tab-SummaryData-GridData-PagingToolbar');
