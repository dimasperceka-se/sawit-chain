...
Ext.define('Koltiva.view.SpatialTools.MainView' ,{
    extend: 'Ext.panel.Panel',
    id: 'Koltiva.view.SpatialTools.MainView',
    ...
    listeners: {
        afterRender: function(){
            var thisObj = this;
            var totalData = 0;
            Ext.getCmp('Koltiva.view.SpatialTools.MainView').initMap()
        }
    },
    initComponent: function() {
        var thisObj = this;
        //Store
        thisObj.StoreGridUploadFarmPolygon = Ext.create('Koltiva.store.SpatialTools.GridUploadFarmPolygon', {});
                            ...
                            dockedItems: [        
                                {
                                    ...
                                    items: [
                                            ...
                                            items: [{            
                                                ...
                                                listeners: {
                                                    'change': function(fb, v){
                                                        ...
                                                        form.submit({
                                                            url: m_api+'/map/import_farm_polygon_client_kml',
                                        ...
                                        }),
                                        {
                                            ...
                                            handler: function() {
                                                Ext.Ajax.request({
                                                    url: m_api+'/map/farm_polygon_client_clear_data',
                                                    method: "POST",
                                        ...
                                        {
                                            xtype: 'label',
                                            html:`<a href="https://koltiva.s3.ap-southeast-1.amazonaws.com/gis/template/TEMPLATE_UPLOAD_FROM_GPS_HANDHELD_OR_THIRD_PARTY_APPS.kml"><i>File Template [KML]</i></a>`
                                        },
                                        {
                                            xtype: 'label',
                                            id:'right-button',
                                            html: '<a id="info-button" href="#" onClick="javascript:popup.show();"><img src="'+m_url+'images/icons/maps/book-pile-white.png" style="width: 18px; height: 18px;"></a>'
                                        }          
                                    ]
                                },
                            ],
                                ...
                                items: [{
                                    ...
                                    listeners: {
                                        'click': function(){
                                            $.ajax({
                                                type: "GET",
                                                url: m_api + '/map/farm_polygon_client_export_excel',
                                    ...
                                    handler: function() {
                                        var form = Ext.getCmp('upload').getForm();                              
                                        form.submit({
                                            url: m_api+'/map/update_farm_polygon_client',
                    ...
                    items:[
                        {
                            xtype: 'component',
                            autoEl: {
                                html: '<div id="map" style="width:100%;height:790px;background:#e1e1e1;border:1px solid #e1e1e1;"></div><div style="position:absolute;z-index:9;color:#F2F2F2;top:720px; padding-left:10px;text-shadow: 2px 2px gray;"> <i>Powered by KoltiGIS for Partner</i></div>',
                            }
                        }
                    ]
                },{
                    html: '<div style="position:absolute;z-index:9;color:white;top:700px"> Powered by KoltiGIS for Partner</div>'
                }]
            }]
        }];
    ...
    // Koltiva.view.SpatialTools.MainView-MainMap-innerCt
})