Ext.define('Koltiva.view.menu.MainFormMenu' ,{
    extend: 'Ext.panel.Panel',
    id: 'Koltiva.view.menu.MainFormMenu',
    ...
    initComponent: function() {
        ...
        function backToList(){
            Ext.getCmp('Koltiva.view.menu.MainFormMenu').destroy(); //destory current view
                ...
                afterrender: function(c){
                    ...
                    Ext.Ajax.request({
                        ...
                        success: function(fp, o){
                            ...
                            Ext.getCmp('Koltiva.view.menu.MainFormMenu-form-MenuId').setValue(r.MenuId);
                            Ext.getCmp('Koltiva.view.menu.MainFormMenu-form-MenuParentId').setValue(r.MenuParentId);
                            Ext.getCmp('Koltiva.view.menu.MainFormMenu-form-MenuName').setValue(r.MenuName);
                            Ext.getCmp('Koltiva.view.menu.MainFormMenu-form-MenuModule').setValue(r.MenuModule);
                            Ext.getCmp('Koltiva.view.menu.MainFormMenu-form-MenuIcon').setValue(r.MenuIcon);
                            Ext.getCmp('Koltiva.view.menu.MainFormMenu-form-MenuOrder').setValue(r.MenuOrder);
                            Ext.getCmp('Koltiva.view.menu.MainFormMenu-form-MenuJenis').setValue(r.MenuJenis);
                            Ext.getCmp('Koltiva.view.menu.MainFormMenu-form-MenuParam').setValue(r.MenuParam);
