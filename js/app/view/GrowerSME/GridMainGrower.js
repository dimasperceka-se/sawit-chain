/*
 * @Author: fashah
 * @Date:   2021-05-16 12:10:39
 * @Last Modified by:   fashah
 * @Last Modified time: 2021-12-18 13:40:27
 */
...
var contextMenuGrid = Ext.create('Ext.menu.Menu', {
    items: [{
        ...
        handler: function () {
            ...
            Ext.getCmp('Koltiva.view.GrowerSME.GridMainGrower-MainPanel').destroy(); //destory current view
...
var storeGridMain = Ext.create('Koltiva.store.GrowerSME.GridMain');
...
Ext.define('Koltiva.view.GrowerSME.GridMainGrower', {
    extend: 'Ext.panel.Panel',
    id: 'Koltiva.view.GrowerSME.GridMainGrower-MainPanel',
    ...
    initComponent: function () {
        ...
        thisObj.items = [{
            ...
            dockedItems: [{
                ...
                items: [{
                        ...
                        menu: {
                            items: [{
                                    ...
                                    handler: function () {
                                        ...
                                        param_string += ' &SupplychainID='+m_supplychain_id;
                    ...
                    },
                    {
                        ...
                        handler: function () {
                            //display field grid
                            var winGridDisplay = Ext.create('Koltiva.view.GrowerSME.WinGridDisplay');
                        ...
                        handler: function () {
                            //advanced search
                            var winAdvFilter = Ext.create('Koltiva.view.GrowerSME.WinAdvancedFilter');
            ...
            columns: [{
                ...
                id: 'view.Grower.GridMainGrower-colDateStart',
                text: 'Date Start',
                width: '9%',
                dataIndex: 'DateStart'
            }, {
                id: 'view.Grower.GridMainGrower-colDateEnd',
                text: 'Date End',
                width: '9%',
                dataIndex: 'DateEnd'
            }, {
                id: 'view.Grower.GridMainGrower-colExpired',
                text: 'Status',
                width: '9%',
                dataIndex: 'Expired'
            }, {
