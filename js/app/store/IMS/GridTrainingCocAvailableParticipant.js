 ...
 *  File : GridTrainingCocAvailableParticipant.js
 *******************************************/

Ext.define('Koltiva.store.IMS.GridTrainingCocAvailableParticipant', {
    extend: 'Ext.data.Store',
    storeId: 'Koltiva.store.IMS.GridTrainingCocAvailableParticipant',
    id: 'Koltiva.store.IMS.GridTrainingCocAvailableParticipant',
    ...
    proxy: {
        type: 'ajax',
        url: m_api + '/ims_training/grid_training_coc_available_participant',
        reader: {
            type: 'json',
            root: 'data'
        }
