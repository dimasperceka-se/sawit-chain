...
*/
Ext.define('Koltiva.store.IMS.GridMappingFAFarmer', {
    extend: 'Ext.data.Store',
    storeId: 'Koltiva.store.IMS.GridMappingFAFarmer',
    id: 'Koltiva.store.IMS.GridMappingFAFarmer',
    ...
    proxy: {
        type: 'ajax',
        url: m_api + '/ims/grid_mapping_fa_farmer',
        reader: {
            type: 'json',
            root: 'data',
            totalProperty: 'total'
