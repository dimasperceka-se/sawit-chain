...
Ext.define('Koltiva.store.Cooperatives.CooperativesFarmerGroupPanelGrid', {
    extend: 'Ext.data.Store',
    id: 'Koltiva.store.Cooperatives.CooperativesFarmerGroupPanelGrid',
    storeId: 'Koltiva.store.Cooperatives.CooperativesFarmerGroupPanelGrid',
