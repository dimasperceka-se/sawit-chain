Ext.define('Koltiva.store.Report.Transaction.ComboSupplyID', {
    extend: 'Ext.data.Store',
    id: 'Koltiva.store.Report.Transaction.ComboSupplyID',
    storeId: 'Koltiva.store.Report.Transaction.ComboSupplyID',
    fields: [
        {name: 'id', mapping: 'id'},
