...
Ext.define('Koltiva.store.ComboGeneral.CmbCertHolderGeneral', {
    extend: 'Ext.data.Store',
    id: 'Koltiva.store.ComboGeneral.CmbCertHolderGeneral',
    storeId: 'Koltiva.store.ComboGeneral.CmbCertHolderGeneral',
    fields: ['id', 'label'],
    autoLoad: false,
    storeVar: false,
