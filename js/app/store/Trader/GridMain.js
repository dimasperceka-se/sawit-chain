...
*/
Ext.define('Koltiva.store.Trader.GridMain', {
    extend: 'Ext.data.Store',
    id: 'Koltiva.store.Trader.GridMain',
    fields: ['MemberIDInc','id', 'Name','Desa','Kecamatan','LastUpdated','Province','District','Birthdate','Age','DateCollection','Handphone','Enumerator','MemberRole'],
    pageSize: 50,
    autoLoad: false,
    remoteSort: true,
    proxy: {
        ...
        url: m_api + '/trader_mem/grid_main',
        reader: {
            type: 'json',
            root: 'data',
            totalProperty: 'total'
    ...
    listeners: {
        ...
        beforeload: function(store, operation, options){
            var ptextSearch, pAdvRowHandphone, pAdvTextHandphone, pAdvRowAge, pAdvOpAge, pAdvTextAge;
            ...
            store.proxy.extraParams.roleSearch = pCmbRoleSearch.toString();
