Ext.define('Koltiva.store.Traceability.Transaction.GridTransactionBatch', {
    extend: 'Ext.data.Store',
    id: 'Koltiva.store.Traceability.Transaction.GridTransactionBatch',
    storeId: 'Koltiva.store.Traceability.Transaction.GridTransactionBatch',
    ...
    listeners: {
        beforeload: function(store, operation, options){
            ...
            store.proxy.extraParams.SupplyBatchID = Ext.getCmp('Koltiva.view.Traceability.Transaction.WinBatchFrom-Form-SupplyBatchID').getValue();
        }, 
        load: function(store, record) {
            ...
            Ext.getCmp('Koltiva.view.Traceability.Transaction.WinBatchFrom-Form-VolumeNetto').setValue(netto.toFixed(2));
            Ext.getCmp('Koltiva.view.Traceability.Transaction.WinBatchFrom-Form-DestNumberPackage').setValue(tandan);
