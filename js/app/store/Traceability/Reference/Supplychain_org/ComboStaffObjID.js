...
Ext.define('Koltiva.store.Traceability.Reference.Supplychain_org.ComboStaffObjID', {
    extend: 'Ext.data.Store',
    id: 'Koltiva.store.Traceability.Reference.Supplychain_org.ComboStaffObjID',
    storeId: 'Koltiva.store.Traceability.Reference.Supplychain_org.ComboStaffObjID',
    fields: ['id','label'],
    autoLoad: false,
    storeVar: false,
