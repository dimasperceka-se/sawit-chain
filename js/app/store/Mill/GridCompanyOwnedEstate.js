...
Ext.define('Koltiva.store.Mill.GridCompanyOwnedEstate', {
    extend: 'Ext.data.Store',
    id: 'Koltiva.store.Mill.GridCompanyOwnedEstate',
    storeId: 'Koltiva.store.Mill.GridCompanyOwnedEstate',
    ...
    proxy: {
        type: 'ajax',
        url: m_api + '/mill/grid_company_owned_estate',
        reader: {
            type: 'json',
            root: 'data',
            totalProperty: 'total'
