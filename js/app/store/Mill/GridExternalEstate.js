...
Ext.define('Koltiva.store.Mill.GridExternalEstate', {
    extend: 'Ext.data.Store',
    id: 'Koltiva.store.Mill.GridExternalEstate',
    storeId: 'Koltiva.store.Mill.GridExternalEstate',
