...
Ext.define('Koltiva.store.Traceability_new.Reference.Supplychain_org_rel.cmbObject', {
    extend: 'Ext.data.Store',
    storeId: 'Koltiva.store.Traceability_new.Reference.Supplychain_org_rel.cmbObject',
    id: 'Koltiva.store.Traceability_new.Reference.Supplychain_org_rel.cmbObject',
    ...
    proxy: {
        type: 'ajax',
        url: m_api + '/traceability_api/Supplychain_org_rel/sid', 
        reader: {
            type: 'json',
            root: 'data',
            totalProperty: 'total'
