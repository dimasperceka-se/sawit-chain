...
Ext.define('Koltiva.store.Traceability_new.Reference.Supplychain_org.ComboStaffObjID', {
    extend: 'Ext.data.Store',
    id: 'Koltiva.store.Traceability_new.Reference.Supplychain_org.ComboStaffObjID',
    storeId: 'Koltiva.store.Traceability_new.Reference.Supplychain_org.ComboStaffObjID',
    fields: ['id','label'],
    autoLoad: false,
    storeVar: false,
