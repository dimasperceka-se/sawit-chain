...
Ext.define('Koltiva.store.Refinery.GridOtherSupplier', {
    extend: 'Ext.data.Store',
    id: 'Koltiva.store.Refinery.GridOtherSupplier',
    storeId: 'Koltiva.store.Refinery.GridOtherSupplier',
