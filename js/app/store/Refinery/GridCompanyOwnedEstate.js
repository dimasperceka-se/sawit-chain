...
Ext.define('Koltiva.store.Refinery.GridCompanyOwnedEstate', {
    extend: 'Ext.data.Store',
    id: 'Koltiva.store.Refinery.GridCompanyOwnedEstate',
    storeId: 'Koltiva.store.Refinery.GridCompanyOwnedEstate',
    ...
    proxy: {
        type: 'ajax',
        url: m_api + '/refinery/grid_company_owned_estate',
        reader: {
            type: 'json',
            root: 'data',
            totalProperty: 'total'
