...
Ext.define('Koltiva.store.Refinery.GridPlasma', {
    extend: 'Ext.data.Store',
    id: 'Koltiva.store.Refinery.GridPlasma',
    storeId: 'Koltiva.store.Refinery.GridPlasma',
    ...
    proxy: {
        type: 'ajax',
        url: m_api + '/refinery/grid_plasma',
        reader: {
            type: 'json',
            root: 'data',
            totalProperty: 'total'
