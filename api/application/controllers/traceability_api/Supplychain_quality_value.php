...
class Supplychain_quality_value extends REST_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('traceability_api/m_supplychain_quality_value','_model');
    }
    public function fetch_get() {
        ...
        $data  = $this->_model->get_data($this->get('QualityID'), $this->recordStart, $this->recordLimit, $this->sortingField, $this->sortingDir);
        if($data){
