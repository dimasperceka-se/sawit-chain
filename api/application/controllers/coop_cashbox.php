...
class Coop_cashbox extends REST_Controller {
	...
	function getcashsourcelist_get(){
        ...
        if($this->input->get('cashboxName') != ''){ $filter['coop_cash_source.cashSourceName'] = $this->input->get('cashboxName'); }
        if($this->input->get('COACode') != ''){ $filter['coop_cash_source.coaCode'] = $this->input->get('COACode'); }
        if($this->input->get('bankNo') != ''){ $filter['coop_cash_source.cashSourceNo'] = $this->input->get('bankNo'); }
