...
class Dashboard_export_detail_ksatria_sawit extends REST_Controller {
    ...
    public function palm_oil_mill_get($ProgID,$ClusterID,$Lockdate) {
        ...
        $DataList = $this->mpro_kpi->palm_oil_mill_ks_export($DateGenerated,$ProgID,$ClusterID);
    ...
    public function palm_sme_get($ProgID,$ClusterID,$Lockdate) {
        $ProgID = (int) $ProgID;
        $ClusterID = (int) $ClusterID;
        $UrlFilenya = null;
        ...
        //$DateGenerated = $this->mjbcocoakpi->GetCurrentDateGenerated($ProgID);
        $DateGenerated = $Lockdate;
        $DataList = $this->mpro_kpi->palm_sme_ks_export($DateGenerated,$ProgID,$ClusterID);
        if($DataList['count_data'] == 0){
            $DataReturn['success'] = true;
            $DataReturn['count_data'] = 0;
            $this->response($DataReturn, 200);
    ...
    public function palm_farmer_get($ProgID,$ClusterID,$Lockdate) {
        $ProgID = (int) $ProgID;
        $ClusterID = (int) $ClusterID;
        $UrlFilenya = null;
        ...
        //$DateGenerated = $this->mjbcocoakpi->GetCurrentDateGenerated($ProgID);
        $DateGenerated = $Lockdate;
        $DataList = $this->mpro_kpi->farmer_registered_ks_export($DateGenerated,$ProgID,$ClusterID);
        if($DataList['count_data'] == 0){
            $DataReturn['success'] = true;
            $DataReturn['count_data'] = 0;
            $this->response($DataReturn, 200);
    ...
    public function palm_plantation_get($ProgID,$ClusterID,$Lockdate) {
        $ProgID = (int) $ProgID;
        $ClusterID = (int) $ClusterID;
        $UrlFilenya = null;
        ...
        //$DateGenerated = $this->mjbcocoakpi->GetCurrentDateGenerated($ProgID);
        $DateGenerated = $Lockdate;
        $DataList = $this->mpro_kpi->palm_plantation_ks_export($DateGenerated,$ProgID,$ClusterID);
        if($DataList['count_data'] == 0){
            $DataReturn['success'] = true;
            $DataReturn['count_data'] = 0;
            $this->response($DataReturn, 200);
    ...
    public function palm_plantation_area_get($ProgID,$ClusterID,$Lockdate) {
        $ProgID = (int) $ProgID;
        $ClusterID = (int) $ClusterID;
        $UrlFilenya = null;
        ...
        //$DateGenerated = $this->mjbcocoakpi->GetCurrentDateGenerated($ProgID);
        $DateGenerated = $Lockdate;
        $DataList = $this->mpro_kpi->palm_plantation_area_ks_export($DateGenerated,$ProgID,$ClusterID);
        if($DataList['count_data'] == 0){
            $DataReturn['success'] = true;
            $DataReturn['count_data'] = 0;
            $this->response($DataReturn, 200);
    ...
    public function farmgate_get($ProgID,$ClusterID,$Lockdate) {
        ...
        //$DateGenerated = $this->mjbcocoakpi->GetCurrentDateGenerated($ProgID);
        $DateGenerated = $Lockdate;
        $DataList = $this->mpro_kpi->farmgate_ks_export($DateGenerated,$ProgID,$ClusterID);
        if($DataList['count_data'] == 0){
            $DataReturn['success'] = true;
            $DataReturn['count_data'] = 0;
            $this->response($DataReturn, 200);
    ...
    public function farmgatetrace_get($ProgID,$ClusterID,$Lockdate) {
        $ProgID = (int) $ProgID;
        $ClusterID = (int) $ClusterID;
        $UrlFilenya = null;
        ...
        //$DateGenerated = $this->mjbcocoakpi->GetCurrentDateGenerated($ProgID);
        $DateGenerated = $Lockdate;
        $DataList = $this->mpro_kpi->farmgatetrace_ks_export($DateGenerated,$ProgID,$ClusterID);
        if($DataList['count_data'] == 0){
            $DataReturn['success'] = true;
            $DataReturn['count_data'] = 0;
            $this->response($DataReturn, 200);
    ...
    public function farmcloud_get($ProgID,$ClusterID,$Lockdate) {
        ...
        //$DateGenerated = $this->mjbcocoakpi->GetCurrentDateGenerated($ProgID);
        $DateGenerated = $Lockdate;
        $DataList = $this->mpro_kpi->farmcloud_ks_export($DateGenerated,$ProgID,$ClusterID);
        if($DataList['count_data'] == 0){
            $DataReturn['success'] = true;
            $DataReturn['count_data'] = 0;
            $this->response($DataReturn, 200);
