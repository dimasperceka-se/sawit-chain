...
<div id="templatemo_container_wrapper">
    <div class="page">
        ...
        <div id="containerSurat">
            ...
            <p>
                <?php echo lang('conNo dengan ini parHDL1')?>
            </p>

            <p>
                <?php echo lang('conNo saya menginformasikan parHDL2')?>
            </p>

            <p>
                <?php echo lang('conNo saya setuju parHDL3')?>
            </p>

            <p>
                <?php echo lang('conNo persetujuan ini parHDL4')?>
            </p>
            <br />
