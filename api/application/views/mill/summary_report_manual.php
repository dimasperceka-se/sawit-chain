        ...
        <div id='templatemo_container_wrapper'>
                    ...
                    <table width="50%" border="0" cellpadding="2">
                        <tr>
                            <td height="100px" width="25%" style="vertical-align:middle;">
                                <?php
                                    if($PhotoSrc != ""){
                                        $logo = base_url().'/images/mill/'.$Province.'/'.$PhotoSrc;
                                    }else{
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $dataChartTracable = '["Traceable",'.$tracable.'],["Untraceable",'.(100-$tracable).']';
                                ?>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <table width="100%" border="0" cellpadding="2" style="border:2px solid #95130b;">
                        <tr>
                            <td height="60px" width="25%" align="center" style="vertical-align:middle;">
                                ...
                                <h3 style="position:absolute;top:220;left:370"><?=$tracable?>%<br>Traceable</h3>
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <div class="page">                
                <div class="row">
                    <table class="table">
                        <thead>
                            <tr><th colspan="4"><?=lang("Company Owned Estate (Estate Inti)")?></th></tr>
                            <tr>
                ...
                <div class="row" style="margin-top:20px">
                    <table class="table">
                        <thead>
                            <tr><th colspan="4"><?=lang("Plasma Smallholder")?></th></tr>
                            <tr>
                                <th><?=lang("Nama Supplier")?></th>
                                <th><?=lang("Kategori Kebun")?></th>
                                <th><?=lang("FFB Supply (Ton)")?></th>
                ...
                <div class="row" style="margin-top:20px">
                    <table class="table">
                        <thead>
                            <tr><th colspan="4"><?=lang("Other Suppliers (Direct Smallholder, Dealer/Agent/Vendor)")?></th></tr>
                            <tr>
                                <th><?=lang("Nama Supplier")?></th>
                                <th><?=lang("Kategori Kebun")?></th>
                                <th><?=lang("FFB Supply (Ton)")?></th>
                ...
                <div class="row" style="margin-top:20px">
                    <table class="table">
                        <thead>
                            <tr><th colspan="4"><?=lang("External Estates")?></th></tr>
                            <tr>
                                <th><?=lang("Nama Supplier")?></th>
                                <th><?=lang("Kategori Kebun")?></th>
                                <th><?=lang("FFB Supply (Ton)")?></th>
