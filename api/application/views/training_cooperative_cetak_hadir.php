            ...
            <table width="100%" border="0" cellpadding="2" style="font-size: 16px; margin-top: -10px;">
                <tr>
                    <td align="center" style="vertical-align:middle;"><span style="text-decoration:underline;"><?php echo lang('Daftar Hadir') ?></span><br/>
                        <span style=""><?php echo $data['CoopTrainingName']?></span>
                    </td>
                </tr>
            </table>
        </div>
                    ...
                    <div class="text_area">
                        ...
                        <table width="100%" cellspacing="0" style="border : 1px solid #000000;">
                            <tr style="padding:4px;">
                                <td width="30%"><?php echo lang('Nama Koperasi') ?></td><td width="20%"><input style = "border: 1px solid #999;background-color: #FFF"  type="text" value="<?php echo $data['CoopName']?>" disabled size="25"></td>
                                <td width="30%"><?php echo lang('Location') ?></td><td width="20%"><input style = "border: 1px solid #999;background-color: #FFF"  type="text" value="<?php echo $data['Location']?>" disabled size="25"></td>
                            </tr>
                            <tr>
                                <td><?php echo lang('Service Provider') ?></td><td><input style = "border: 1px solid #999;background-color: #FFF"  type="text" value="<?php echo $data['ServiceProvName']?>" disabled size="25"></td>
                                <td><?php echo lang('Kabupaten') ?></td><td><input style = "border: 1px solid #999;background-color: #FFF"  type="text" value="<?php echo $data['District']?>" disabled size="25"></td>
                            </tr>
                            <tr>
                                <td><?php echo lang('Petugas Lapangan') ?></td><td><input style = "border: 1px solid #999;background-color: #FFF"  type="text" value="<?php echo $data['FacilitatorStaff']?>" disabled size="25"></td>
                                <td><?php echo lang('Provinsi') ?></td><td><input style = "border: 1px solid #999;background-color: #FFF"  type="text" value="<?php echo $data['Province']?>" disabled size="25"></td>
                            </tr>
                            <tr>
                                <td><?php echo lang('Tanggal Pertama Pelatihan') ?></td><td><input style = "border: 1px solid #999;background-color: #FFF"  type="text" value="<?php echo $data['TrainingStart']?>" disabled size="25"></td>
                                <td><?php echo lang('Tanggal Terakhir Pelatihan') ?></td><td><input style = "border: 1px solid #999;background-color: #FFF"  type="text" value="<?php echo $data['TrainingEnd']?>" disabled size="25"></td>
                            </tr>
                            <tr>
                                <td><?php echo lang('Hari Pelatihan ke') ?></td><td><input style = "border: 1px solid #999;background-color: #FFF"  type="text" value="<?php echo $DayNumber?>" disabled size="25"></td>
                                <td><?php echo lang('Tanggal Pelatihan') ?></td><td><input style = "border: 1px solid #999;background-color: #FFF"  type="text" value="" disabled size="25"></td>
                            </tr>
                        </table>
                    </div>
                </div>
                    ...
                    <div class="text_area">
                        <table width="100%" border="1" cellspacing="0" style="border:1px solid #000000;">
                            <tr style="background-color: #CCCCCC;border:1px solid #000000;" align= "center">
                                <td><strong><?php echo lang('Nomor') ?></strong></td2>
                                <td><strong><?php echo lang('Nama Petani') ?></strong></td>
                                <td><strong><?php echo lang('L/P') ?></strong></td>
                                <td><strong><?php echo lang('Desa') ?></strong></td>
                                <td><strong><?php echo lang('Kehadiran Pagi') ?></strong></td>
                                <td><strong><?php echo lang('Kehadiran Siang') ?></strong></td>
                            </tr>
                            <?for ($i=0;$i<sizeof($peserta);$i++)
                            {?>
                            <tr style="border:1px solid #000000;"><td align = "center" height="50"><?php echo $peserta[$i]['MemberID']?></td>
                                <td height="25">&nbsp;&nbsp;<?php echo $peserta[$i]['Name']?></td>
                                <td align = "center" height="25" style="text-align:center"><?php echo ($peserta[$i]['Gender']=='1')?'L':'P'?></td>
                                <td>&nbsp;&nbsp;<?php echo $peserta[$i]['Village']?></td>
                                <td style="text-align: center;"><?php echo (!empty($peserta[$i]['Attendance1'])?lang('Ya'):'') ?></td>
                                <td style="text-align: center;"><?php echo (!empty($peserta[$i]['Attendance2'])?lang('Ya'):'') ?></td>
                            </tr>
                            <?
                ...
                <div class="section_box3" align="center">
                    <div class="text_area">
                        <table width="100%"  cellspacing="0">
                            ...
                            <tr><td width="255px" align="center"><?php echo lang('Koordinator Lapangan') ?></td>
                                <td width="255px" align="center"><?php echo lang('Fasilitator Mitra') ?></td></tr>
