            ...
            <div id="templatemo_container_wrapper">
                <div id="templatemo_container">
                    <div class="text_area">
                        ...
                        <table width="100%" >
                            <tr>
                                <td valign="top" width="30%">Delivery ID</td>
                                <td valign="top">:</td>
                                <td valign="top"><?php echo $batch['DeliveryID'] ?></td>
                            </tr>
                            
                            <tr>
                                <td valign="top" width="30%">From</td>
                                <td valign="top">:</td>
                                <td valign="top"><?php echo $batch['Name'] ?></td>
                            </tr>

                            <?php
                            if($batch['SupplyDestType'] == 'do'){
                                $SupplyDestType = 'Do & Mill';
                            } elseif ($batch['SupplyDestType'] == 'mill'){
                                $SupplyDestType = 'Mill';
                            } else {
                                $SupplyDestType = 'Agent';
                            }
                            ?>
                            
                            <tr>
                                <td valign="top" width="30%">Dest Type</td>
                                <td valign="top">:</td>
                                <td valign="top"><?php echo $SupplyDestType ?></td>
                            </tr>
                            
                            <?php
                            if($batch['SupplyDestDoOrgID'] != ''){
                                $DestinationDo = $batch['DestinationDo'];
                            } else {
                                $DestinationDo = '-';
                            }
                            ?>
                            ...
                            <?php
                            if($batch['DestinationOtherMill'] != ''){
                                $DestinationOtherMill = $batch['DestinationOtherMill'];
                            } else {
                                $DestinationOtherMill = '-';
                            }
                            ?>

                            <tr>
                                <td valign="top" width="30%">Destination DO</td>
                                <td valign="top">:</td>
                                <td valign="top"><?php echo $DestinationDo; ?></td>
                            </tr>
                            <tr>
                                <td valign="top" width="30%">Destination Mill</td>
                                <td valign="top">:</td>
                                <td valign="top"><?php echo $DestinationMill; ?></td>
                            </tr>
                            <tr>
                                <td valign="top" width="30%">Destination Other Mill</td>
                                <td valign="top">:</td>
                                <td valign="top"><?php echo $DestinationOtherMill; ?></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td valign="top">:</td>
                                <td valign="top"><?php echo $batch['SupplyBatchDate'] ?></td>
                            </tr>
                            <tr>
                                <td valign="top">Delivery Date</td>
                                <td valign="top">:</td>
                                <td valign="top"><?php echo $batch['DeliveryDate'] ?></td>
                            </tr>
                            <tr>
                                <td valign="top" width="40%">Gross Weight</td>
                                <td valign="top">:</td>
                                <td valign="top"><?php echo $batch['TotalWeight']; ?></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td valign="top">:</td>
                                <td valign="top"><?php echo $batch['DestDriver']; ?></td>
                            </tr>
                            <tr>
                                <td valign="top">License Plate</td>
                                <td valign="top">:</td>
                                <td valign="top"><?php echo $batch['DestTransportNumber'] ?></td>
                            </tr>
