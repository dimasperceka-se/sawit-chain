...
<html lang="en">
    ...
    <body>
        ...
        <button type="button" style="<?php echo $hakAksesPolygonStyle;?>" class="btn btn-primary" id="edit-polygon">Edit Polygon</button>
        ...
        <script type="text/javascript">
            ...
            function send_data () {
                ...
                $.ajax({
                    ...
                    type: 'PUT',
                    data: {
                        NurseryID : "<?php echo $NurseryID; ?>",
                        NurseryNr : "<?php echo $NurseryNr; ?>",
                        area: area,
                        luas : $('#luas').val(),
                        lat: lati,
                        long : langi,
