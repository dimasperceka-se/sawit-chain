                        ...
                        <table width="100%">
                            <tr><td height="60" width="200px" align="center" style="vertical-align:middle;">
                                ...
                                <td height="60"  align="center" style="vertical-align:middle;font-size: 14px;">
                                    ...
                                    Nama Pedagang <?php echo  $batch['pedagang'] ?><br>
            ...
            <div id="templatemo_container_wrapper">
                <div id="templatemo_container">
                    ...
                    <div class="text_area">
                        ...
                        <table width="100%">
                            <tr><td width="20%">Nama</td><td>: <?php echo  $batch['DestDriver'] ?></td></tr>
                            <tr><td>Jabatan</td><td>: Sopir</td></tr>
                            <!--<tr><td>Alamat</td><td>: <?php ?></td></tr>-->
                        </table><br>
                        Membawa Kakao Traceability dari <?php echo  $batch['Name'] . ', ' . $batch['District'] ?> dengan berat <?php echo  $batch['DestWeight'] ?> Kg.
                        Kendaraan yang digunakan Truck/Pick Up No Polisi <?php echo  $batch['DestNoPolisi'] ?> dengan tujuan :<br><br>
                        <table width="100%">
                    ...
                    <div class="text_area">
                        <table width="100%" cellspacing="0" style="border: 2px double;border-collapse:collapse;">
                            <thead class="post_title_main" style="text-align:center">
                                <tr>
                                    <th style="border:1px solid" width="5%">No</th>
                                    <th style="border:1px solid" width="35%">No. PO</th>
                                    <th style="border:1px solid" width="60%">Nama Unit / Petani</th>
                                </tr>
                            </thead>
                            <tbody>
                            <?php
