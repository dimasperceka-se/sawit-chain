...
<div id="templatemo_container_wrapper">
    <div class="page">
        ...
        <div id="containerSurat">
            ...
            <p>
                <?php echo lang('conNo persetujuan sinarmas part1')?>
            </p>

            <p>
                <?php echo lang('conNo persetujuan sinarmas part2')?>
            </p>

            <p>
                <?php echo lang('conNo persetujuan sinarmas part3')?>
            </p>

            <?php echo lang('conNo persetujuan sinarmas part4')?>
