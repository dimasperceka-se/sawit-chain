 ...
 *  File : cetak_proj_bg_template_wildasia.php
 *******************************************/
?>
    ...
    <div class="page">
        ...
        <br /><br />
            ...
            <tr>
                ...
                <td>
                <?php echo lang('printProjBg Project Description Text WildAsia')?>
                </td>
            </tr>
            <tr>
                <td height="15" colspan="2"></td>
            ...
            <tr>
                ...
                <td>
                <?php echo lang('printProjBg Data which is not going to be shared Text WildAsia')?>
                </td>
            </tr>
            </table>
        </div>
