...
/**
 * @Author: nikolius
 * @Date:   2017-11-06 10:19:04
 * @Last Modified by:   nikolius
 * @Last Modified time: 2017-11-06 10:31:19
 */
?>
    ...
    <div class="page">
        ...
        <br /><br />
            ...
            <tr>
                ...
                <td>
                <?php echo lang('printProjBg Project Description Text SNV')?>
                </td>
            </tr>
            <tr>
                <td height="15" colspan="2"></td>
            ...
            <tr>
                ...
                <td>
                <?php echo lang('printProjBg Data which is not going to be shared Text SNV')?>
                </td>
            </tr>
            </table>
        </div>
