...
/**
 * @Author: nikolius
 * @Date:   2017-10-09 11:55:01
 * @Last Modified by:   nikolius
 * @Last Modified time: 2017-10-09 12:18:27
 */
?>
<div id="templatemo_container_wrapper">
    ...
    <div class="page">
        ...
        <tr>
            ...
            <td>
            <?php echo lang('printProjBg Project Description Text Sinar Mas')?>
            </td>
        </tr>
        <tr>
            <td height="15" colspan="2"></td>
        ...
        <tr>
            ...
            <td>
            <?php echo lang('printProjBg Data which is not going to be shared Text Sinar Mas')?>
            </td>
        </tr>
        </table>
