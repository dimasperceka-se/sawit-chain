...
<head>
   ...
   <!-- CSS -->
   <link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>assets/css/farmer_summary_loan/site_global.css"/>
   <link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>assets/css/farmer_summary_loan/index.css" />
