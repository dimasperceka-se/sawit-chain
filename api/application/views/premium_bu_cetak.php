...
<body>
    <div class="page">
        ...
        <table width="100%" cellspacing="0">
            <tr>
                <td height="60"  width="25%" rowspan="2" align="center" style="vertical-align:middle;">
                    <!--<img src="<?=base_url()?>images/coop/Payung Bersama.jpg" style="width:40%;">-->
                    <?php if($logo['logo_koperasi']!=''){ ?>
                      <img src="<?=base_url()?>images/<?=$logo['logo_koperasi']?>" width="70" height="50">
                    <? } ?>
                </td>
                <td height="60" align="center" style="font-size: 11pt; text-align: center; font-weight: bold;vertical-align:middle;">Laporan Premium per Buying Unit</td>
                <td height="60" rowspan="2" width="25%" align="center" style="vertical-align:middle;">
                   <!--<img src="<?=base_url()?>images/certification_provider/20160106105232_logo-ra-transparent.png" style="width:40%">-->
        ...
        <table class="table table-bordered">
            ...
            <?php 
            if ($Nameb != $value['name_b']): 
                $Nameb = $value['name_b'];
            ?>
                <tr>
                    <th colspan="9" style="text-align:left"><?php echo $Nameb ?></th>
                </tr>
            <?php endif ?>
                <tr>
                    <td><?=$value['name']?></td>
                    <td style="text-align:right;"><?php echo number_format($value['survey'],2,',','.') ?></td>
                    <td style="text-align:right;"><?php echo number_format($value['quota'],2,',','.') ?></td>
                    <td style="text-align:right;"><?php echo number_format($value['bruto'],2,',','.') ?></td>
                    <td style="text-align:right;"><?php echo number_format($value['netto'],2,',','.') ?></td>
                    <td style="text-align:right;"><?php echo number_format($value['balance'],2,',','.') ?></td>
                    <td style="text-align:right;"><?php echo number_format($value['totalidr'],2,',','.') ?></td>
                    <td style="text-align:right;"><?php echo number_format($value['totalusd'],2,',','.') ?></td>
