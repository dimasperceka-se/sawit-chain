 ...
 *  File : cetak_consent_notes_template_wildasia.php
 *******************************************/
?>
...
<div id="templatemo_container_wrapper">
    <div class="page">
        ...
        <div id="containerSurat">
            ...
            <p>
                <?php echo lang('conNo persetujuan wildasia part1')?>
            </p>
            ...
            <p>
                <?php echo lang('conNo persetujuan wildasia part3')?>
            </p>

            <?php echo lang('conNo persetujuan wildasia part4')?>
