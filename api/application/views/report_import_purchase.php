...
<table width="100%" cellspacing="1" cellpadding="1" class="summary" border="<?php echo $border; ?>">
  <tr>
    <td colspan="4" id="title1"><div align="center"><b>Transaksi Pembelian <?=SetTanggal($start)?> s.d. <?=SetTanggal($end)?></b></div></td>
  </tr>
</table>
<table cellspacing="1" cellpadding="1" class="summary" border="<?php echo $border; ?>">
  <tr>
      ...
      <td id="title1" width="350"><div align="center"><b>Nama</b></div></td>
      <td id="title1" width="350"><div align="center"><b>BatchNumber</b></div></td>
