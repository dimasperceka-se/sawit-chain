                ...
                <div class="section_box2" align="center">
                    <div class="text_area">
                        ...
                        <table width="100%" cellspacing="0" style="border : 1px solid #000000;">
                            <tr style="background-color: #CCCCCC;padding:2px;"><td width="50%" colspan="2"><?php echo lang('TRAINING');?></td>
                                <td width="50%" colspan="2"></td></tr>
                            <tr style="padding:4px;"><td width="30%"><?php echo lang('Petugas Lapangan');?></td><td width="20%"><input style = "border: 1px solid #999;background-color: #FFF"  type="text" value="<?=$data['koordinator']?>" disabled size="25"></td>
                                <td width="30%"><?php echo lang('Provinsi');?></td><td width="20%"><input style = "border: 1px solid #999;background-color: #FFF"  type="text" value="<?=$data['Provinsi']?>" disabled size="25"></td></tr>
                            <tr><td><?php echo lang('Tempat ToT');?></td><td><input style = "border: 1px solid #999;background-color: #FFF"  type="text" value="<?=$data['TotLocation']?>" disabled size="25"></td>
                                <td><?php echo lang('Kabupaten');?></td><td><input style = "border: 1px solid #999;background-color: #FFF"  type="text" value="<?=$data['Kabupaten']?>" disabled size="25"></td></tr>
