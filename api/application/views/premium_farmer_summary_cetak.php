    ...
    <div class="page">
        ...
        <table width="100%" cellspacing="0">
            <tr>
                ...
                <td height="60" align="center" style="font-size: 11pt; text-align: center; font-weight: bold;vertical-align:middle;"><?php echo $judul; ?></td>
        ...
        <table class="table table-bordered">
            ...
            <?php
                ...
                foreach ($report as $key => $val) {
                    ...
                    echo '<tr>';
                        echo '<td>'.$val['name'].'</td>';
                        echo '<td style="text-align:right;">'.number_format($val['survey'],2,',','.').'</td>';
                        echo '<td style="text-align:right;">'.number_format($val['quota'],2,',','.').'</td>';
                        echo '<td style="text-align:right;">'.number_format($val['bruto'],2,',','.').'</td>';
                        echo '<td style="text-align:right;">'.number_format($val['netto'],2,',','.').'</td>';
                        echo '<td style="text-align:right;">'.number_format($val['balance'],2,',','.').'</td>';
                        echo '<td style="text-align:right;">'.number_format($val['totalidr'],2,',','.').'</td>';
                        echo '<td style="text-align:right;">'.number_format($val['totalusd'],2,',','.').'</td>';

                        echo '<td style="text-align:right;">'.number_format($val['paidkg'],2,',','.').'</td>';
                        echo '<td style="text-align:right;">'.number_format($val['unpaidkg'],2,',','.').'</td>';
                        echo '<td style="text-align:right;">'.number_format($val['paidusd'],2,',','.').'</td>';
                        echo '<td style="text-align:right;">'.number_format($val['unpaidusd'],2,',','.').'</td>';
                    echo '</tr>';
                    $i++;
                }
