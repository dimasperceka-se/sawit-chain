                ...
                ?>
                            <div class="page">
								...
								<table width="100%" cellspacing="4" class="header" style="border-top:none">
									<tr><td><?php echo lang('Survey') ?></td><td align="right"><?=$survey['surveya']?></td></tr>
								</table>

								<table width="100%" cellspacing="10" class="body" cellpadding="5">
									<tr>
									...
									<tr>
										<td colspan="3" width="75%"><?php echo lang('Kira-kira berapa penghasilan tahunan Bapak/Ibu dari penjualan biji kakao?') ?></td>
										<td class="line" width="25%">
											<?//= number_format( $v['AmountCocoaIncome'] , 0 , '.' , ',' ) ?>
										<td>
									</tr>
									<tr>
										<td colspan="3" width="75%"><?php echo lang('Kira-kira berapa penghasilan Bapak/Ibu per tahun selain dari penjualan biji kakao?') ?></td>
										<td class="line" width="25%">
