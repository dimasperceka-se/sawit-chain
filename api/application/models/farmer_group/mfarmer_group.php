...
class Mfarmer_group extends CI_Model {
    ...
    public function getFarmerGroupBasicDataForm($FarmerGroupID){
        $sql="SELECT
                ...
                IFNULL(a.`Latitude`, ST_Y(a.LatLong)) AS \"Koltiva.view.FarmerGroup.FormMainFarmerGroup-FormBasicData-Latitude\",
                IFNULL(a.`Longitude`, ST_X(a.LatLong)) AS \"Koltiva.view.FarmerGroup.FormMainFarmerGroup-FormBasicData-Longitude\",
