...
EOD;
    ...
    protected function getCellXfsSectionContent()
    {
        ...
        foreach ($registeredStyles as $style) {
            ...
            //Tambahan agar bisa diformat jadi number, tidak teks semua (nikolius 14/09/2017)
            $content .= '<xf numFmtId="164" fontId="' . $styleId . '" fillId="' . $fillId . '" borderId="' . $borderId . '" xfId="0" applyNumberFormat="1" ';
