...
/**
 * @Author: nikolius
 * @Date:   2017-09-08 17:19:04
 * @Last Modified by:   nikolius
 * @Last Modified time: 2017-09-22 15:08:40
 */
if (!defined('BASEPATH')) {
    exit('No direct script access allowed');
}

class Trainings extends SS_Controller
{
    ...
    public function index($prov = '', $kab = '')
    {
        ...
        $data['js']    = 'progre_dboard/master_training';
        $data['action'] = array_merge(
            array(
                ...
                'petani' => $_GET['petani'],
                'tahun' => $data['tahun'],
                'data'  => $this->api . '/dboard/dash_get_pro_master_training'
            ),
            $this->action
        );
        $data['title'] = $this->titlet . lang('Master Trainings');
        $data['mentokDistrict'] = true;
        $this->LoadView($data, 'progre_dboard/master_training');
    }
