...
/**
 * @Author: nikolius
 * @Date:   2017-09-08 17:09:46
 * @Last Modified by:   nikolius
 * @Last Modified time: 2017-09-19 16:30:42
 */
if (!defined('BASEPATH')) {
    exit('No direct script access allowed');
}

class Ppi_surveys extends SS_Controller
{
    ...
    public function index($prov = '', $kab = '')
    {
        ...
        $data['js']    = 'progre_dboard/ppi_survey';
        $data['action'] = array_merge(
                array(
                    ...
                    'petani' => $_GET['petani'],
                    'tahun' => $data['tahun'],
                    'data'  => $this->api . '/dboard/dash_get_pro_ppi_survey'
                ),
                $this->action
        );
        $data['title'] = $this->titlet . lang('PPI Surveys');
        $data['mentokDistrict'] = true;
        $this->LoadView($data, 'progre_dboard/ppi_survey');
    }
