...
class Dash_traceability extends SS_Controller {
    ...
    public function index($prov='',$kab='',$kec='',$desa='',$private='') {
            ...
            $data['js'] = 'home/dash_traceability_new';
            $data['action'] = array_merge(
                    ...
                    'awal'=>$_GET['awal'],
                    'akhir'=>$_GET['akhir'],
                    'data'=>$this->api.'/dboard/dash_get_traceability',
                    'now'=>date('Y')
                ),
                $this->action
            );
            ...
            $this->LoadView($data, 'home_traceability_new');
    }
