...
/**
 * @Author: gitandi
 * @Date:   2019-06-27 11:45:02
 * @Last Modified by:   gitandi
 * @Last Modified time: 2019-06-27 11:45:02
 */
if (!defined('BASEPATH')) {
    exit('No direct script access allowed');
}

class Dash_supplychain_traceability extends SS_Controller
{
    ...
    public function index($prov = '', $kab = '')
    {
        ...
        $data['js']    = 'dashboard/dash_supplychain_traceability';
        $data['action'] = array_merge(
            array(
                ...
                // 'petani' => $_GET['petani'],
                // 'tahun' => $data['tahun'],
                'data'  => $this->api . '/dboard/dash_supplychain_traceability'),
                $this->action
        );
        ...
        $data['title'] = $this->titlet . lang('Supply Chain Traceability');
        $this->LoadView($data, 'dashboard/dash_supplychain_traceability');
    }
