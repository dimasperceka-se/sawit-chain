...
/**
 * @Author: nikolius
 * @Date:   2017-05-12 10:45:52
 */
if (!defined('BASEPATH')) {
    exit('No direct script access allowed');
}

class Dash_train_kpis extends SS_Controller
{
    ...
    public function index($prov = '', $private = '', $kab = '')
    {
        ...
        $data['action'] = array_merge(
            array(
                ...
                'petani' => $_GET['petani'],
                'tahun' => $data['tahun'],
                'data'  => $this->api . '/dashboard/dash_train_kpis'),
                $this->action
        );
        $data['title'] = $this->titlet . lang('Training KPIs');
        $this->LoadView($data, 'dashboard/dash_train_kpis');
    }
}
?>