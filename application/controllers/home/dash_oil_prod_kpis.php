...
/**
 * @Author: nikolius
 * @Date:   2017-05-12 10:17:52
 */
if (!defined('BASEPATH')) {
    exit('No direct script access allowed');
}

class Dash_oil_prod_kpis extends SS_Controller
{
    ...
    public function index($prov = '', $private = '', $kab = '')
    {
        ...
        $data['js']    = 'home/dash_oil_prod_kpis';
        ...
        $data['action'] = array_merge(
            array(
                ...
                'petani' => $_GET['petani'],
                'tahun' => $data['tahun'],
                'data'  => $this->api . '/dashboard/dash_oil_prod_kpis'),
                $this->action
        );
        $data['title'] = $this->titlet . lang('Oil Production KPIs');
        $this->LoadView($data, 'dashboard/dash_oil_prod_kpis');
    }
}
?>