...
/**
 * @Author: nikolius
 * @Date:   2017-05-12 11:05:39
 */
if (!defined('BASEPATH')) {
    exit('No direct script access allowed');
}

class Dash_community_kpis extends SS_Controller
{
    ...
    public function index($prov = '', $private = '', $kab = '')
    {
        ...
        $data['js']    = 'home/dash_community_kpis';
        ...
        $data['action'] = array_merge(
            array(
                ...
                'petani' => $_GET['petani'],
                'tahun' => $data['tahun'],
                'data'  => $this->api . '/dashboard/dash_community_kpis'),
                $this->action
        );
        $data['title'] = $this->titlet . lang('Training KPIs');
        $this->LoadView($data, 'dashboard/dash_community_kpis');
    }
