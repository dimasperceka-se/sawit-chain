...
/**
 * @Author: nikolius
 * @Date:   2018-01-16 07:25:17
 * @Last Modified by:   nikolius
 * @Last Modified time: 2018-01-16 07:47:20
 */
...
class Agent_demographic extends SS_Controller
{
    ...
    public function index($prov = '', $kab = '')
    {
        ...
        $data['js']    = 'dashboard/agent_demographic';
        $data['action'] = array_merge(
            array(
                ...
                'petani' => $_GET['petani'],
                'tahun' => $data['tahun'],
                'data'  => $this->api . '/dboard/dash_get_agent_demographic'),
                $this->action
        );
        $data['title'] = $this->titlet . lang('Use of Agri-Inputs');
        $data['mentokDistrict'] = true;
        $this->LoadView($data, 'dashboard/agent_demographic');
    }
