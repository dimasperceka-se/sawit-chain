...
class Supplychain_detail extends SS_Controller {
    ...
    public function index()
    {
        ...
        $data['action'] = array(
            ...
            'url_geospatial'                    => $api.'/geospatial_new/maps',
            'url_supplychain'                   => $api.'/geospatial_new/supplychain',
            'url_supplychain_cpg'               => $api.'/geospatial_new/supplychain_cpg',
            'url_supplychain_farmer'            => $api.'/geospatial_new/supplychain_farmer',
            'url_supplychain_refinery'          => $api.'/geospatial_new/supplychain_refinery',
            'url_districtmap'                   => $api.'/geospatial_new/districtmap',
            'url_districtmap_bank'              => $api.'/geospatial_new/bank_districtmap',
            'url_geospatialbydistrict'          => $api.'/geospatial_new/map',
            'url_geospatialbydistrict_bank'     => $api.'/geospatial_new/bank_map',
            'url_geospatialbank'                => $api.'/geospatial_new/bank',
            'url_province'                      => $api.'/geospatial_new/province',
            'url_weather'                       => $api.'/geospatial_new/weather',
            ...
            'm_cetak_mill_profile'              => $api.'/mill/cetak_mill_profiles/',
            'm_cetak_agent_profile'              => $api.'/grower/cetak_agent_profiles/',
            'm_cetak_farmer_summary'            => $api.'/farmer/cetak_farmer_summary_loan/',
            'url_ceksurvey'             => $api.'/farmer/data_CekSurvey',
            'url_district'              => $api.'/geospatial_new/district',
            'url_province_partner'      => $api.'/geospatial_new/partner',
            'url_bank'                  => $api.'/bank/banglist',
            'url_info'                  => site_url('maps/map'),
            'url_area'                  => $api.'/geospatial_new/area',
            'url_clone_area'            => $api.'/geospatial_new/clonal_area',
            'url_partner'               => $api.'/farmer/data_partner',
            'act_default'               => false,
            'act_supplychain'           => true,
            'act_bank'                  => false,
            );
        ...
        // }
        if (!empty($get['area'])) {
            $api_farmer = $api."/geospatial_new/garden_detail/FarmerID/{$get['farmer']}/GardenNr/{$get['garden']}";
            ...
            //     $area['area'] = $polygon;
            // }
            $area['api_area'] = $api.'/geospatial_new/area';
        ...
        $this->LoadView($data, 'map/supplychain_detail');
    }
