            ...
            <div class="panel panel-sign" style="margin-bottom:150px; width:750px;">
                <div class="panel-title-sign mt-xl text-right">
                    <h2 class="title text-uppercase text-bold m-none" style="background-color:#95130b!important"><i
                            class="fa fa-user mr-xs"></i> Term of Use </h2>
                </div>
                <div class="panel-body" style="border-top-color:#95130b!important;padding:20px!important;">
                    <!-- isi -->
                    <p style="text-align: center;"><strong>Term of Use</strong></p>
                ...
                <ul>
                    ...
                    <li>
                    User access to the PalmoilTrace Application can be used onward or undisturbed, because the use of this PalmoilTrace Application also depends on cellular signals and also the condition of the hardware.
                    </li>
                </ul>

                <br>
                <p><strong>Your Obligation</strong></p>
                    <br>
                    <ul>
                        <p>
                        <strong>1. General Obligation</strong>
                        </p>
                        <p>
                        ...
                        <ul>
                            ...
                            <li style="list-style: none;">
                            •	Do not try to change, copy, emulate, and disassemble data or system of PalmoilTrace Application.
                            </li>
                        </ul>
                        <br>
                        <p>
                        <strong>3. Usage Limits</strong>
                        </p>
                        <p>
                        The use of the PalmoilTrace Application can be restricted according to the access rights and responsibilities of each user and You can see the restrictions on the PalmoilTrace Application user interface.
                        </p>
                        <br>
                        <p>
                ...
                <ol>
                    <li>
                    You acknowledge that you have the authority to use the PalmoilTrace Application, and to access information and Data that you input into the PalmoilTrace Application, including any information or Data entered into the PalmoilTrace Application by anyone you have authorized to use the PalmoilTrace Application.
                    </li>
                    <li>
                    ...
                    <li>
                    To determine that our PalmoilTrace Application meets your needs and can be used in accordance with the objectives is your own responsibility.
                    </li>
                </ol>
