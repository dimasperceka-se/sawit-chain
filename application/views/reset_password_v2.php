                ...
                <div class="panel panel-sign">
                    ...
                    <div class="panel-body" style="border-top-color:#95130b!important;padding:20px 20px 8px 20px !important">
                        ...
                        <div class="alert alert-info">
                            <p class="m-none text-semibold h6">Your password must fit these criteria</p>
                            <ul>
                        ...
                        <form id="formReset" action="<?php echo site_url('system/login/reset_proc') ?>" method="post">
                            ...
                            <div class="row">
                                <div class="col-sm-12 text-right">
                                    ...
                                    <button id="formReset-btnSubmit" disabled="" type="submit" class="btn btn-success btn-lg hidden-xs col-sm-12">Reset Password & Login</button>
                                </div>
                            </div>
                            <br />
                        </form>
                        ...
                        <div class="alert alert-danger">
                            <p class="m-none text-semibold h6">This request is already expired!</p>
                        </div>
                        <?php }?>
                    </div>
                </div>
