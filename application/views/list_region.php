<div class="btn-group btn-hspace pull-right">
    <button class="btn btn-default dropdown-toggle" data-toggle="dropdown" type="button" aria-expanded="false"><span id="judul"><?php echo lang($current_region) ?></span>&nbsp;<span class="caret"></span></button>
...
<script type="text/javascript">
    //cek region status
    var param_region_status;
    if( typeof m_region_status !== 'undefined' ) {
        param_region_status = m_region_status;
    }else{
        param_region_status = null;
    }
    ...
    // $(function(){
        $.ajax({
            ...
            data: {
                ...
                kab: m_kab,
                daer: m_daer,
                region_status: param_region_status
            },
        })
        .done(function(data) {
            // console.log(data);
            ...
            if (!m_prov && !m_kab && !m_priv) {
                ...
                url = m_path+m_prov+'/';
                if (!m_daer) {
                    //url += 'null/'; bikin bug ketika m_daer tak ada null sehingga kab/district gk kebaca
                };
            } else if(m_kab){
                current_id = m_kab;
            ...
            //destroy param agar tereset paramnya
            if( typeof m_region_status !== 'undefined' ) {
                m_region_status = undefined;
            }
        })
        .fail(function() {
            // console.log("error");
