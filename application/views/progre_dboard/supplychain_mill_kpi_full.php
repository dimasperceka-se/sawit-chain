        ...
        <div class="row">
            ...
            <div class="col-md-11">
                <div class="btn-group btn-hspace pull-right">
                    <button style="height:30px;padding: 0px 4px !important;" class="btn btn-default pull-right" data-original-title=".btn .btn-info" data-placement="top" rel="tooltip" onclick="openFilter()"><?php echo lang('Apply Filter') ?></button>
                    <input type="hidden" id="SupChainMillPartnerIDFilter" value="<?php echo $_SESSION['PartnerID'] ?>" />
                    <input type="hidden" id="SupChainMillFirstLoad" value="1" />
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="widget widget-download-list">
                        <div class="widget-head">
                            <div class="col-md-8">
                                ...
                                <div class="desc">
                                    <?php echo lang('Palmoil Plantations Area (Ha)') ?>
                                </div>
                            </div>
                            <div class="widget-icon col-md-4"><img src="<?php echo base_url() ?>img/general/land_area.png"></div>
                        </div>
                        <ul class="widget-list colapsed">
                            <li><a class="link_garden" data-type="farmer" href="#"><span class="label"><?php echo lang('Farmer') ?></span><span class="value" id="farmer_plant_ha"></span> </a></li>
                            <li><a class="link_garden" data-type="sme" href="#"><span class="label"><?php echo lang('SME') ?></span><span class="value" id="sme_plant_ha"></span> </a></li>
                            <li><a class="link_garden" data-type="mill" href="#"><span class="label"><?php echo lang('Mill') ?></span><span class="value" id="mill_plant_ha"></span> </a></li>
                ...
                <div class="col-md-3">
                    <div class="widget widget-tile hvr-fade">
                        <div class="data-info col-md-8">
                            ...
                            <div class="desc">
                                <?php echo lang('Palmoil Agents Mapped') ?>
                            </div>
                        </div>
