        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="widget widget-tile hvr-fade">
                    <div class="data-info col-md-8">
                        ...
                        <div class="desc">
                            <?php echo lang('Palm Oil Farmer Plantations Area (Ha)')?>
                        </div>
                    </div>
            ...
            <div class="col-md-3">
                <div class="widget widget-download-list">
                    ...
                    <ul class="widget-list colapsed" id="sme_detail">
                    </ul>
                </div>
            </div>
            <div class="col-md-3">
                <div class="widget widget-download-list">
                    <div class="widget-head widget-tile">
                        <!--<div class="data-info col-md-8">-->
                        <div class="col-md-8">
                            <div class="value" id="box_agents_plantaion">0</div>
                            <div class="desc">
                                <?php echo lang('Palm Oil SME Plantation Area (Ha)') ?>
                            </div>
                        </div>
                        <div class="widget-icon col-md-4"><img src="<?php echo base_url() ?>img/general/land_area.png"></div>
                        <!--</div>-->
                    </div>
                    <ul class="widget-list colapsed" id="sme_plantation_detail">
                    </ul>
                </div>
            </div>
        </div>
