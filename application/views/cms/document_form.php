...
<div class="main-content" style="background: #fff; min-height: 1500px;">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group back-to-list">
                                <a id="backLink" href="#">
                                    <i class="fa fa-arrow-left"></i> Back to Document List
                                </a>
                            </div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="Name" class="form-control form-title validate" placeholder="Title">
                            </div>
                            <div class="form-group">
                                <label class="properties-title">Summary</label>
                                <textarea id="document-summary" class="form-control form-summary validate" name="Summary" placeholder="Write your summary here"></textarea>
                            </div>
                            <div class="dropzone">
                                <label for="files" class="dropzone-container">
                                    ...
                                    <div class="dropzone-title">
                                        Drag and drop your document file or <span class='browse'>browse</span> your files
                                    </div>
                                </label>
                            ...
                            <div class="form-group">
                                <div id="document-url"></div>
                            </div>
                            <div>
                                <i class="fa fa-file-pdf-o" aria-hidden="true"  id="pdf" ></i>

                            </div>
                            <div class="panel panel-default m-t-20">
                                <label class="properties-title" style="margin-bottom: 10px;">Description</label>
                                <textarea id="document-description" class="description validate" name="Description"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="news-access-users">
                    <form action="#">
                        <div class="form-group m-t-10">
                            ...
                            <select class="form-control" id="document-status" name="StatusType">
                                <option></option>
                        ...
                        <div class="form-group m-t-10">
                            ...
                            <div class="input-group xs-mb-15"><span class="input-group-addon glyphicon glyphicon-user"></span>
                                <input readonly type="text" name="PostedBy" placeholder="@Sinta Ruch" class="form-control">
                            </div>
                        </div>
                        <!--div>
                            <div class="row">
    ...
    <script type="text/javascript" src="<?php echo base_url() ?>js/modules/cms/document_form.js?2"></script> 
</div>