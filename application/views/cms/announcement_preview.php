<div class="main-content" style="background: #fff; min-height: 1500px;">
    ...
    <div class="news-container">
        <div class="col-md-9 left-side">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="row">
                                    <select class="form-control" id="np-language-switcher" name="Language">
                                        <option value=""></option>
            ...
            <div class="grid-content clearfix" id="preview-announcement"></div>
        </div>
    ...
    <script src="<?php echo base_url() ?>js/modules/cms/announcement.js"></script>
    <script type="text/javascript">
        preView();
        $(document).ready(function() {
            //initialize the javascript
            $('#np-language-switcher').select2({
                width: '100%',
