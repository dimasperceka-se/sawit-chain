<div class="main-content" style="background: #fff; min-height: 1500px;">
    ...
    <div class="cms-container">
        <div class="col-md-9 left-side">
            ...
            <div class="grid-content clearfix" id="main-document"></div>
        ...
        <div class="col-md-3 right-side" style="display: none">
            <div class="side-component">
                ...
                <div class="sidebar-item search-form">
                    <form action="">
                        <input type="text" name="search-form-value-document">
                        <button id="search-form-action-document"><i class="fa fa-search"></i></button>
                    </form>
    ...
    <script src="<?php echo base_url() ?>js/modules/cms/document.js?2"></script>
