...
<div class="main-content" style="background: #fff; min-height: 1500px;">
                ...
                <div class="grid-content clearfix">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <label class="properties-title">Video Link</label>
                                <input type="text" class="form-control form-videourl validate" placeholder="Video URL" name="VideoUrl">
                                <input type="hidden" name="VideoTypeID">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="panel panel-default m-t-20">
                                <label class="properties-title">Description</label>
                                <textarea id="video-description" class="description validate" name="Description"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="news-access-users">
                    <form action="#">
                        <div class="form-group m-t-10">
                            ...
                            <select class="form-control" id="video-status" name="StatusType">
                                <option></option>
                        ...
                        <div class="form-group m-t-10">
                            <label for="video-type" class="properties-title">Video Type</label>
                            <select class="form-control" id="video-type" name="VideoType">
                                <option></option>
    ...
    <script type="text/javascript" src="<?php echo base_url() ?>js/modules/cms/video_form.js?4"></script> 
</div>