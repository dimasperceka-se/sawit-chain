...
<script src="<?php echo base_url() ?>js/modules/map/partner.js"></script>
<script type="text/javascript">
	// load googlemap
...
<div class="panel panel-default hidden" id="panel-filter" style="margin-left: 10px;">
	...
	<div id="sidebar-filter" style="width: 380px;">
		...
		<div class="panel-body">
			<div id="accordion0" class="panel-group accordion" style="margin-bottom: 5px;">
				<div class="panel panel-default">
					<div class="panel-heading">
						<h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion0" href="#collapsePartner" class="collapsed" aria-expanded="false"><i class="icon s7-angle-down"></i> <?php echo lang('Partner') ?></a></h4>
					</div>
					<div id="collapsePartner" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
						<div class="panel-body" id="panel-partner">
					...
					<div id="collapseOne" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
						<div class="panel-body" style="padding-right: 0px;">							
							<div id="accordion1A" class="panel-group accordion" style="margin-bottom: 0px; padding-bottom: 0px;">
								<div class="panel panel-default">
									<div class="panel-heading">
										<h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion1A" href="#collapseOneA" aria-expanded="false" class="collapsed"><i class="icon s7-angle-down"></i> <?php echo lang('Forest Area') ?></a></h4>
									</div>
								...
								<div class="panel panel-default">
									<div class="panel-heading">
										<h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion1A" href="#collapseOneB" aria-expanded="false" class="collapsed"><i class="icon s7-angle-down"></i> <?php echo lang('Production Forest') ?></a></h4>
									</div>
