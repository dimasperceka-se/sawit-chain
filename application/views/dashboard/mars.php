    ...
    <div id='row-fluid' style="display:none">
        <div class="page-head xs-pt-10 xs-pb-10">
            <div class="row">
                ...
                <div class="col-md-10">
                    <?php echo $this->load->view('list_region_mars', $action, TRUE); ?>
                    <?php echo $this->load->view('list_certification_holder_mars', $action, TRUE); ?>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-md-3">
                        <div class="widget widget-tile hvr-fade">
                            <div class="data-info col-md-8">
                                ...
                                <div class="desc">
                                    <?php echo lang('Actual Volume in District (MT)') ?>
                                </div>
                            </div>
                            <div class="icon col-md-4"><img src="<?php echo base_url()?>img/general/cpg2.png"></div>
                        </div>
