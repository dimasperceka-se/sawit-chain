            ...
            <form class="form-horizontal" id="form-profile" method="post">
                <table class="table table-condensed" style="font-size:1em;line-height:0px;border:0">
                    ...
                    <tbody>
                        <tr>
                            <th><?=lang('Group');?></th>
                            <td><?=$profile[0]['GroupName']?></td>
                        </tr>
                        <tr>
                            <th><?=lang('Unit');?></th>
                            <td><?=$profile[0]['UnitName']?></td>
                        </tr>
                        <tr>
                            <th><?=lang('Active status');?></th>
                            <td><?=$profile[0]['UserActive']?></td>
                        </tr>
                        <tr>
                            <th><?=lang('Language');?></th>
                            <td>
                                <select data-placeholder="Choose your language" class="chzn-select" id="default-select" name="UserLanguage">
                                    <option value=""></option>
                        ...
                        <tr>
                            ...
                            <td>
                                <select data-placeholder="Choose your notification status" class="chzn-select" id="default-select" name="UserNotification">
                                    <option value=""></option>
                                    <option value="Official Email Only">Official Email Only</option>
                                    <option value="Official and Private Email">Official and Private Email</option>
                                </select>
                            </td>
                        </tr> 
                        <tr>
